...
& v1,v2,v3,gTAh,gThh,gTHm,gTVWm,gTVZ,gFuFucFdFd,gFuFucFeFe,gFuFucFuFu,gFuFuFvFv,         & 
...
& cplcFuFuVZR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVZL,cplFvFvVZR,deltaM)
...
gFuFuFvFvi = 0._dp 
Call FuToFuFvFv(i_run,MFu,MFv,MVZ,MAh,Mhh,cplcFuFuAhL,cplcFuFuAhR,cplcFuFuhhL,        & 
...
& NSs,NSSss,NVs,NVSss,NVVss,gTVZtemp,gTAhtemp,gThhtemp,deltaM,epsI,check,gFuFuFvFvi)

gFuFuFvFv(i_run,:,:,:) = gFuFuFvFvi 
gT(i_run) = gT(i_run) + Sum(gFuFuFvFvi) 
 
gFuFdcFeFvi = 0._dp 
Call FuToFdcFeFv(i_run,MFd,MFe,MFv,MVWm,MHm,MFu,cplcFeFvHmL,cplcFeFvHmR,              & 
...
Real(dp),Intent(in) :: MFu(3),MFd(3),MVZ,MVWm,MHm(2),MAh(3),Mhh(3)
...
Real(dp),Intent(in) :: MFu(3),MFe(3),MVZ,MAh(3),Mhh(3)
...
Real(dp),Intent(in) :: MFu(3),MVZ,MAh(3),Mhh(3)
...
Subroutine FuToFuFvFv(iIN,MFu,MFv,MVZ,MAh,Mhh,cplcFuFuAhL,cplcFuFuAhR,cplcFuFuhhL,    & 
& cplcFuFuhhR,cplcFuFuVZL,cplcFuFuVZR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,       & 
& cplFvFvVZL,cplFvFvVZR,IntegralSs,IntegralSSss,IntegralVs,IntegralVSss,IntegralVVss,    & 
...
Real(dp),Intent(in) :: MFu(3),MFv(6),MVZ,MAh(3),Mhh(3)
...
Subroutine FuToFdcFeFv(iIN,MFd,MFe,MFv,MVWm,MHm,MFu,cplcFeFvHmL,cplcFeFvHmR,          & 
& cplcFeFvVWmL,cplcFeFvVWmR,cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,       & 
& IntegralSs,IntegralSSss,IntegralVs,IntegralVSss,IntegralVVss,NSs,NSSss,NVs,            & 
...
Real(dp),Intent(in) :: MFd(3),MFe(3),MFv(6),MVWm,MHm(2),MFu(3)
