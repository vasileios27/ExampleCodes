...
Module CouplingsForDecays_BGLNCS
...
& ZHinput,ZPinput,ZWinput,ZZinput,g1input,g2input,g3input,Lam1input,Lam3input,           & 
...
& Mubinput,Mu3input,v1input,v2input,v3input,cplcFuFuAhL,cplcFuFuAhR,cplcFuFdcHmL,        & 
...
& Y1n21input,Y1n22input,Y2n33input,C13input,C23input,C31input,C32input,BB11input,        & 
& BB12input,BB21input,BB22input,Aa1input,Aa2input,Mu1input,Mu2input,MuDashinput,         & 
& Mubinput,Mu3input,v1input,v2input,v3input,cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,         & 
...
& Y1n21input,Y1n22input,Y2n33input,C13input,C23input,C31input,C32input,BB11input,        & 
& BB12input,BB21input,BB22input,Aa1input,Aa2input,Mu1input,Mu2input,MuDashinput,         & 
& Mubinput,Mu3input,v1input,v2input,v3input,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,         & 
...
& Y1n21input,Y1n22input,Y2n33input,C13input,C23input,C31input,C32input,BB11input,        & 
& BB12input,BB21input,BB22input,Aa1input,Aa2input,Mu1input,Mu2input,MuDashinput,         & 
& Mubinput,Mu3input,v1input,v2input,v3input,cplFvFvAhL,cplFvFvAhR,cplFvFecHmL,           & 
& cplFvFecHmR,cplFvFecVWmL,cplFvFecVWmR,cplFvFvhhL,cplFvFvhhR,cplFvFvVZL,cplFvFvVZR,deltaM)
...
Complex(dp),Intent(out) :: cplFvFvAhL(6,6,3),cplFvFvAhR(6,6,3),cplFvFecHmL(6,3,2),cplFvFecHmR(6,3,2),            & 
...
& Y1n21input,Y1n22input,Y2n33input,C13input,C23input,C31input,C32input,BB11input,        & 
& BB12input,BB21input,BB22input,Aa1input,Aa2input,Mu1input,Mu2input,MuDashinput,         & 
& Mubinput,Mu3input,v1input,v2input,v3input,cplHiggsPP,cplHiggsGG,cplHiggsZZvirt,        & 
& cplHiggsWWvirt,cplAhAhhh,cplAhhhhh,cplAhhhVZ,cplcFdFdhhL,cplcFdFdhhR,cplcFeFehhL,      & 
& cplcFeFehhR,cplcFuFuhhL,cplcFuFuhhR,cplFvFvhhL,cplFvFvhhR,cplhhhhhh,cplhhHmcHm,        & 
...
& Y1n21input,Y1n22input,Y2n33input,C13input,C23input,C31input,C32input,BB11input,        & 
& BB12input,BB21input,BB22input,Aa1input,Aa2input,Mu1input,Mu2input,MuDashinput,         & 
& Mubinput,Mu3input,v1input,v2input,v3input,cplPseudoHiggsPP,cplPseudoHiggsGG,           & 
& cplAhAhAh,cplAhAhhh,cplcFdFdAhL,cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,       & 
& cplcFuFuAhR,cplFvFvAhL,cplFvFvAhR,cplAhhhhh,cplAhhhVZ,cplAhHmcHm,cplAhHmcVWm,deltaM)
...
& Y1n21input,Y1n22input,Y2n33input,C13input,C23input,C31input,C32input,BB11input,        & 
& BB12input,BB21input,BB22input,Aa1input,Aa2input,Mu1input,Mu2input,MuDashinput,         & 
& Mubinput,Mu3input,v1input,v2input,v3input,cplAhHmcHm,cplAhcHmVWm,cplcFuFdcHmL,         & 
& cplcFuFdcHmR,cplFvFecHmL,cplFvFecHmR,cplhhHmcHm,cplhhcHmVWm,cplHmcHmVZ,cplcHmVWmVZ,deltaM)
...
& Y1n21input,Y1n22input,Y2n33input,C13input,C23input,C31input,C32input,BB11input,        & 
& BB12input,BB21input,BB22input,Aa1input,Aa2input,Mu1input,Mu2input,MuDashinput,         & 
& Mubinput,Mu3input,v1input,v2input,v3input,cplAhhhVZ,cplcFdFdVZL,cplcFdFdVZR,           & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFuFuVZL,cplcFuFuVZR,cplFvFvVZL,cplFvFvVZR,cplhhVZVZ,       & 
& cplHmcHmVZ,cplHmcVWmVZ,cplcVWmVWmVZ,deltaM)
...
& Y1n21input,Y1n22input,Y2n33input,C13input,C23input,C31input,C32input,BB11input,        & 
& BB12input,BB21input,BB22input,Aa1input,Aa2input,Mu1input,Mu2input,MuDashinput,         & 
& Mubinput,Mu3input,v1input,v2input,v3input,cplAhHmcVWm,cplcFuFdcVWmL,cplcFuFdcVWmR,     & 
& cplFvFecVWmL,cplFvFecVWmR,cplhhHmcVWm,cplhhcVWmVWm,cplHmcVWmVZ,cplcVWmVWmVZ,deltaM)
...
Complex(dp),Intent(out) :: cplAhHmcVWm(3,2),cplcFuFdcVWmL(3,3),cplcFuFdcVWmR(3,3),cplFvFecVWmL(6,3),             & 
...
& cplcFeFeVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,cplcFuFuAhL,             & 
& cplcFuFuAhR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVZL,cplcFuFuVZR,cplFvFecHmL,               & 
...
& cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFuHmL,cplcFdFuHmR,cplcFdFuVWmL,              & 
& cplcFdFuVWmR,cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,              & 
& cplcFeFeVZR,cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuAhL,         & 
& cplcFuFuAhR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVZL,cplcFuFuVZR,cplFvFecHmL,               & 
& cplFvFecHmR,cplFvFecVWmL,cplFvFecVWmR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,     & 
& cplFvFvVZL,cplFvFvVZR,deltaM)
...
End Module CouplingsForDecays_BGLNCS
