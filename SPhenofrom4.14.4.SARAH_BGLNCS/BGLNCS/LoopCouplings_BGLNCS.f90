...
Subroutine DeltaVB(sinW2,sinW2_dr,rho,MAh,MFe,MFv,Mhh,MHm,MVWm,BB11,BB12,             & 
& BB21,BB22,C13,C23,C31,C32,g2,ZER,v1,v2,ZEL,Vv,Y1e11,Y1e12,Y1e21,Y1e22,Y1n11,           & 
& Y1n12,Y1n21,Y1n22,Y2e33,Y2n33,ZA,ZH,ZP,res)

Implicit None 
Real(dp),Intent(in) :: MAh(3),MFe(3),MFv(6),Mhh(3),MHm(2),MVWm,g2,v1,v2,ZA(3,3),ZH(3,3)

Complex(dp),Intent(in) :: BB11,BB12,BB21,BB22,C13,C23,C31,C32,ZER(3,3),ZEL(3,3),Vv(6,6),Y1e11,Y1e12,            & 
& Y1e21,Y1e22,Y1n11,Y1n12,Y1n21,Y1n22,Y2e33,Y2n33,ZP(2,2)
