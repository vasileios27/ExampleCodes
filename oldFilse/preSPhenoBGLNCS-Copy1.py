...
def RanAngles():
    ...
    delta = np.random.uniform(np.arcsin(1),np.arcsin(0.8))
...
def Fanction_alphas():
    galpha_1 = 0*np.random.uniform(-1*pow(10,-4),+1*pow(10,-4))
    galpha_2 = 0*np.random.uniform(-1*pow(10,-4),+1*pow(10,-4))
    galpha_3 = 0*np.random.uniform(-1*pow(10,-4),+1*pow(10,-4))
