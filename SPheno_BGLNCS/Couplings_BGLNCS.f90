...
& Y1d21,Y1d22,Y1d23,Y2d31,Y2d32,Y2d33,ZDL,ZDR,Y1e11,Y1e22,Y1e21,Y2e33,ZEL,               & 
& ZER,Y1u11,Y1u12,Y1u21,Y1u22,Y2u33,ZUL,ZUR,Y1n11,Y1n22,Y1n12,Y2n33,C23,C32,             & 
& Vv,cplAhAhAh,cplAhAhhh,cplAhhhhh,cplAhHmcHm,cplhhhhhh,cplhhHmcHm,cplAhAhAhAh,          & 
& cplAhAhAhhh,cplAhAhhhhh,cplAhAhHmcHm,cplAhhhhhhh,cplAhhhHmcHm,cplhhhhhhhh,             & 
& cplhhhhHmcHm,cplHmHmcHmcHm,cplAhhhVP,cplAhhhVZ,cplAhHmcVWm,cplAhcHmVWm,cplhhHmcVWm,    & 
& cplhhcHmVWm,cplHmcHmVP,cplHmcHmVZ,cplhhVPVZ,cplhhcVWmVWm,cplhhVZVZ,cplHmcVWmVP,        & 
& cplHmcVWmVZ,cplcHmVPVWm,cplcHmVWmVZ,cplAhAhVPVP,cplAhAhVPVZ,cplAhAhcVWmVWm,            & 
& cplAhAhVZVZ,cplAhHmcVWmVP,cplAhHmcVWmVZ,cplAhcHmVPVWm,cplAhcHmVWmVZ,cplhhhhVPVP,       & 
& cplhhhhVPVZ,cplhhhhcVWmVWm,cplhhhhVZVZ,cplhhHmcVWmVP,cplhhHmcVWmVZ,cplhhcHmVPVWm,      & 
...
& cplcFuFuAhL,cplcFuFuAhR,cplFvFvAhL,cplFvFvAhR,cplcFdFdhhL,cplcFdFdhhR,cplcFuFdcHmL,    & 
& cplcFuFdcHmR,cplFvFecHmL,cplFvFecHmR,cplcFeFehhL,cplcFeFehhR,cplcFuFuhhL,              & 
& cplcFuFuhhR,cplcFdFuHmL,cplcFdFuHmR,cplFvFvhhL,cplFvFvhhR,cplcFeFvHmL,cplcFeFvHmR,     & 
...
& cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFuVZL,cplcFuFuVZR,cplFvFvVPL,cplFvFvVPR,               & 
& cplFvFvVZL,cplFvFvVZR,cplcFeFvVWmL,cplcFeFvVWmR,cplVGVGVGVG1,cplVGVGVGVG2,             & 
...
& cplcgWpgAcVWm,cplcgWmgWmVP,cplcgWmgWmVZ,cplcgAgWmcVWm,cplcgZgWmcVWm,cplcgWpgWpVP,      & 
& cplcgAgWpVWm,cplcgZgWpVWm,cplcgWpgWpVZ,cplcgWmgZVWm,cplcgWpgZcVWm,cplcgWmgWmAh,        & 
& cplcgWpgWpAh,cplcgZgAhh,cplcgWmgAHm,cplcgWpgAcHm,cplcgWmgWmhh,cplcgZgWmcHm,            & 
& cplcgWpgWphh,cplcgZgWpHm,cplcgZgZhh,cplcgWmgZHm,cplcgWpgZcHm)
...
& Y1e11,Y1e22,Y1e21,Y2e33,ZEL(3,3),ZER(3,3),Y1u11,Y1u12,Y1u21,Y1u22,Y2u33,               & 
& ZUL(3,3),ZUR(3,3),Y1n11,Y1n22,Y1n12,Y2n33,C23,C32,Vv(6,6)
...
& Y1d23,Y2d31,Y2d32,Y2d33,ZDL,ZDR,Y1e11,Y1e22,Y1e21,Y2e33,ZEL,ZER,Y1u11,Y1u12,           & 
& Y1u21,Y1u22,Y2u33,ZUL,ZUR,Y1n11,Y1n22,Y1n12,Y2n33,C23,C32,Vv,cplAhAhAh,cplAhAhhh,      & 
...
Subroutine CouplingcFeFeAhT(gt1,gt2,gt3,Y1e11,Y1e22,Y1e21,Y2e33,ZA,ZEL,               & 
& ZER,resL,resR)
...
Complex(dp), Intent(in) :: Y1e11,Y1e22,Y1e21,Y2e33,ZEL(3,3),ZER(3,3)
...
resL = resL-((Y1e21*Conjg(ZER(gt1,1))*Conjg(ZEL(gt2,2))*ZA(gt3,2))/sqrt(2._dp))
...
resR = resR+(Conjg(Y1e21)*ZER(gt2,1)*ZEL(gt1,2)*ZA(gt3,2))/sqrt(2._dp)
...
Subroutine CouplingFvFvAhT(gt1,gt2,gt3,Y1n11,Y1n22,Y1n12,Y2n33,C23,C32,               & 
& ZA,Vv,resL,resR)
...
Complex(dp), Intent(in) :: Y1n11,Y1n22,Y1n12,Y2n33,C23,C32,Vv(6,6)
...
resL = resL+(Y1n12*Conjg(Vv(gt1,5))*Conjg(Vv(gt2,1))*ZA(gt3,2))/sqrt(2._dp)
resL = resL+(Y2n33*Conjg(Vv(gt1,6))*Conjg(Vv(gt2,3))*ZA(gt3,2))/sqrt(2._dp)
resL = resL+(Y1n12*Conjg(Vv(gt1,1))*Conjg(Vv(gt2,5))*ZA(gt3,2))/sqrt(2._dp)
...
resR = resR-((Conjg(Y1n12)*Vv(gt1,5)*Vv(gt2,1)*ZA(gt3,2))/sqrt(2._dp))
resR = resR-((Conjg(Y2n33)*Vv(gt1,6)*Vv(gt2,3)*ZA(gt3,2))/sqrt(2._dp))
resR = resR-((Conjg(Y1n12)*Vv(gt1,1)*Vv(gt2,5)*ZA(gt3,2))/sqrt(2._dp))
...
Subroutine CouplingFvFecHmT(gt1,gt2,gt3,Y1e11,Y1e22,Y1e21,Y2e33,Y1n11,Y1n22,          & 
& Y1n12,Y2n33,ZP,ZEL,ZER,Vv,resL,resR)

Implicit None 

Integer, Intent(in) :: gt1,gt2,gt3
Complex(dp), Intent(in) :: Y1e11,Y1e22,Y1e21,Y2e33,Y1n11,Y1n22,Y1n12,Y2n33,ZP(2,2),ZEL(3,3),ZER(3,3),Vv(6,6)
...
resL = resL+Y1n12*Conjg(ZEL(gt2,1))*Conjg(Vv(gt1,5))*ZP(gt3,2)
...
resR = resR-(Conjg(Y1e21)*ZER(gt2,1)*Vv(gt1,2)*ZP(gt3,2))
...
Subroutine CouplingcFeFehhT(gt1,gt2,gt3,Y1e11,Y1e22,Y1e21,Y2e33,ZH,ZEL,               & 
& ZER,resL,resR)
...
resL = resL-((Y1e21*Conjg(ZER(gt1,1))*Conjg(ZEL(gt2,2))*ZH(gt3,2))/sqrt(2._dp))
...
resR = resR-((Conjg(Y1e21)*ZER(gt2,1)*ZEL(gt1,2)*ZH(gt3,2))/sqrt(2._dp))
...
Subroutine CouplingFvFvhhT(gt1,gt2,gt3,Y1n11,Y1n22,Y1n12,Y2n33,C23,C32,               & 
& ZH,Vv,resL,resR)
...
resL = resL-((Y1n12*Conjg(Vv(gt1,5))*Conjg(Vv(gt2,1))*ZH(gt3,2))/sqrt(2._dp))
resL = resL-((Y2n33*Conjg(Vv(gt1,6))*Conjg(Vv(gt2,3))*ZH(gt3,2))/sqrt(2._dp))
resL = resL-((Y1n12*Conjg(Vv(gt1,1))*Conjg(Vv(gt2,5))*ZH(gt3,2))/sqrt(2._dp))
...
resR = resR-((Conjg(Y1n12)*Vv(gt1,5)*Vv(gt2,1)*ZH(gt3,2))/sqrt(2._dp))
resR = resR-((Conjg(Y2n33)*Vv(gt1,6)*Vv(gt2,3)*ZH(gt3,2))/sqrt(2._dp))
resR = resR-((Conjg(Y1n12)*Vv(gt1,1)*Vv(gt2,5)*ZH(gt3,2))/sqrt(2._dp))
...
Subroutine CouplingcFeFvHmT(gt1,gt2,gt3,Y1e11,Y1e22,Y1e21,Y2e33,Y1n11,Y1n22,          & 
& Y1n12,Y2n33,ZP,ZEL,ZER,Vv,resL,resR)
...
resL = resL-(Y1e21*Conjg(ZER(gt1,1))*Conjg(Vv(gt2,2))*Conjg(ZP(gt3,2)))
resL = resL-(Y2e33*Conjg(ZER(gt1,3))*Conjg(Vv(gt2,3))*Conjg(ZP(gt3,2)))
resR = 0._dp 
resR = resR+Conjg(Y1n11)*Conjg(ZP(gt3,1))*ZEL(gt1,1)*Vv(gt2,4)
resR = resR+Conjg(Y1n12)*Conjg(ZP(gt3,2))*ZEL(gt1,1)*Vv(gt2,5)
...
& cplAhhhhh,cplAhHmcHm,cplhhhhhh,cplhhHmcHm,cplVGVGVG,cplcFdFdAhL,cplcFdFdAhR,           & 
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
  Do gt3 = 1, 3
Call CouplingcFeFeAh2L(gt1,gt2,gt3,Y1e11,Y1e22,Y1e21,Y2e33,ZA,ZEL,ZER,cplcFeFeAhL(gt1,gt2,gt3)& 
& ,cplcFeFeAhR(gt1,gt2,gt3))
...
Do gt1 = 1, 6
 Do gt2 = 1, 6
  Do gt3 = 1, 3
Call CouplingFvFvAh2L(gt1,gt2,gt3,Y1n11,Y1n22,Y1n12,Y2n33,C23,C32,ZA,Vv,              & 
& cplFvFvAhL(gt1,gt2,gt3),cplFvFvAhR(gt1,gt2,gt3))
...
Do gt1 = 1, 6
 Do gt2 = 1, 3
  Do gt3 = 1, 2
Call CouplingFvFecHm2L(gt1,gt2,gt3,Y1e11,Y1e22,Y1e21,Y2e33,Y1n11,Y1n22,               & 
& Y1n12,Y2n33,ZP,ZEL,ZER,Vv,cplFvFecHmL(gt1,gt2,gt3),cplFvFecHmR(gt1,gt2,gt3))
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
  Do gt3 = 1, 3
Call CouplingcFeFehh2L(gt1,gt2,gt3,Y1e11,Y1e22,Y1e21,Y2e33,ZH,ZEL,ZER,cplcFeFehhL(gt1,gt2,gt3)& 
& ,cplcFeFehhR(gt1,gt2,gt3))
...
Do gt1 = 1, 6
 Do gt2 = 1, 6
  Do gt3 = 1, 3
Call CouplingFvFvhh2L(gt1,gt2,gt3,Y1n11,Y1n22,Y1n12,Y2n33,C23,C32,ZH,Vv,              & 
& cplFvFvhhL(gt1,gt2,gt3),cplFvFvhhR(gt1,gt2,gt3))
...
Do gt1 = 1, 3
 Do gt2 = 1, 6
  Do gt3 = 1, 2
Call CouplingcFeFvHm2L(gt1,gt2,gt3,Y1e11,Y1e22,Y1e21,Y2e33,Y1n11,Y1n22,               & 
& Y1n12,Y2n33,ZP,ZEL,ZER,Vv,cplcFeFvHmL(gt1,gt2,gt3),cplcFeFvHmR(gt1,gt2,gt3))
...
Subroutine CouplingcFeFeAh2L(gt1,gt2,gt3,Y1e11,Y1e22,Y1e21,Y2e33,ZA,ZEL,              & 
& ZER,resL,resR)
...
Subroutine CouplingFvFvAh2L(gt1,gt2,gt3,Y1n11,Y1n22,Y1n12,Y2n33,C23,C32,              & 
& ZA,Vv,resL,resR)
...
Subroutine CouplingFvFecHm2L(gt1,gt2,gt3,Y1e11,Y1e22,Y1e21,Y2e33,Y1n11,               & 
& Y1n22,Y1n12,Y2n33,ZP,ZEL,ZER,Vv,resL,resR)
...
Subroutine CouplingcFeFehh2L(gt1,gt2,gt3,Y1e11,Y1e22,Y1e21,Y2e33,ZH,ZEL,              & 
& ZER,resL,resR)
...
Subroutine CouplingFvFvhh2L(gt1,gt2,gt3,Y1n11,Y1n22,Y1n12,Y2n33,C23,C32,              & 
& ZH,Vv,resL,resR)
...
Subroutine CouplingcFeFvHm2L(gt1,gt2,gt3,Y1e11,Y1e22,Y1e21,Y2e33,Y1n11,               & 
& Y1n22,Y1n12,Y2n33,ZP,ZEL,ZER,Vv,resL,resR)
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
  Do gt3 = 1, 3
Call CouplingcFeFeAh2LP(gt1,gt2,gt3,Y1e11,Y1e22,Y1e21,Y2e33,ZA,ZEL,ZER,               & 
& cplcFeFeAhL(gt1,gt2,gt3),cplcFeFeAhR(gt1,gt2,gt3))
...
Do gt1 = 1, 6
 Do gt2 = 1, 6
  Do gt3 = 1, 3
Call CouplingFvFvAh2LP(gt1,gt2,gt3,Y1n11,Y1n22,Y1n12,Y2n33,C23,C32,ZA,Vv,             & 
& cplFvFvAhL(gt1,gt2,gt3),cplFvFvAhR(gt1,gt2,gt3))
...
Do gt1 = 1, 6
 Do gt2 = 1, 3
  Do gt3 = 1, 2
Call CouplingFvFecHm2LP(gt1,gt2,gt3,Y1e11,Y1e22,Y1e21,Y2e33,Y1n11,Y1n22,              & 
& Y1n12,Y2n33,ZP,ZEL,ZER,Vv,cplFvFecHmL(gt1,gt2,gt3),cplFvFecHmR(gt1,gt2,gt3))
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
  Do gt3 = 1, 3
Call CouplingcFeFehh2LP(gt1,gt2,gt3,Y1e11,Y1e22,Y1e21,Y2e33,ZH,ZEL,ZER,               & 
& cplcFeFehhL(gt1,gt2,gt3),cplcFeFehhR(gt1,gt2,gt3))
...
Do gt1 = 1, 6
 Do gt2 = 1, 6
  Do gt3 = 1, 3
Call CouplingFvFvhh2LP(gt1,gt2,gt3,Y1n11,Y1n22,Y1n12,Y2n33,C23,C32,ZH,Vv,             & 
& cplFvFvhhL(gt1,gt2,gt3),cplFvFvhhR(gt1,gt2,gt3))
...
Do gt1 = 1, 3
 Do gt2 = 1, 6
  Do gt3 = 1, 2
Call CouplingcFeFvHm2LP(gt1,gt2,gt3,Y1e11,Y1e22,Y1e21,Y2e33,Y1n11,Y1n22,              & 
& Y1n12,Y2n33,ZP,ZEL,ZER,Vv,cplcFeFvHmL(gt1,gt2,gt3),cplcFeFvHmR(gt1,gt2,gt3))
...
Subroutine CouplingcFeFeAh2LP(gt1,gt2,gt3,Y1e11,Y1e22,Y1e21,Y2e33,ZA,ZEL,             & 
& ZER,resL,resR)
...
Subroutine CouplingFvFvAh2LP(gt1,gt2,gt3,Y1n11,Y1n22,Y1n12,Y2n33,C23,C32,             & 
& ZA,Vv,resL,resR)
...
Subroutine CouplingFvFecHm2LP(gt1,gt2,gt3,Y1e11,Y1e22,Y1e21,Y2e33,Y1n11,              & 
& Y1n22,Y1n12,Y2n33,ZP,ZEL,ZER,Vv,resL,resR)
...
Subroutine CouplingcFeFehh2LP(gt1,gt2,gt3,Y1e11,Y1e22,Y1e21,Y2e33,ZH,ZEL,             & 
& ZER,resL,resR)
...
Subroutine CouplingFvFvhh2LP(gt1,gt2,gt3,Y1n11,Y1n22,Y1n12,Y2n33,C23,C32,             & 
& ZH,Vv,resL,resR)
...
Subroutine CouplingcFeFvHm2LP(gt1,gt2,gt3,Y1e11,Y1e22,Y1e21,Y2e33,Y1n11,              & 
& Y1n22,Y1n12,Y2n33,ZP,ZEL,ZER,Vv,resL,resR)
...
& Y1d22,Y1d23,Y2d31,Y2d32,Y2d33,ZDL,ZDR,Y1e11,Y1e22,Y1e21,Y2e33,ZEL,ZER,Y1u11,           & 
& Y1u12,Y1u21,Y1u22,Y2u33,ZUL,ZUR,Y1n11,Y1n22,Y1n12,Y2n33,C23,C32,Vv,ZP,g3,              & 
& cplAhAhUhh,cplAhUhhhh,cplAhUhhVP,cplAhUhhVZ,cplcFdFdUhhL,cplcFdFdUhhR,cplcFeFeUhhL,    & 
...
& Y1d11,Y1d12,Y1d13,Y1d21,Y1d22,Y1d23,Y2d31,Y2d32,Y2d33,ZDL(3,3),ZDR(3,3),               & 
& Y1e11,Y1e22,Y1e21,Y2e33,ZEL(3,3),ZER(3,3),Y1u11,Y1u12,Y1u21,Y1u22,Y2u33,               & 
& ZUL(3,3),ZUR(3,3),Y1n11,Y1n22,Y1n12,Y2n33,C23,C32,Vv(6,6),ZP(2,2)
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
  Do gt3 = 1, 3
Call CouplingcFeFeUhhL(gt1,gt2,gt3,Y1e11,Y1e22,Y1e21,Y2e33,ZEL,ZER,cplcFeFeUhhL(gt1,gt2,gt3)& 
...
Do gt1 = 1, 6
 Do gt2 = 1, 6
  Do gt3 = 1, 3
Call CouplingFvFvUhhL(gt1,gt2,gt3,Y1n11,Y1n22,Y1n12,Y2n33,C23,C32,Vv,cplFvFvUhhL(gt1,gt2,gt3)& 
& ,cplFvFvUhhR(gt1,gt2,gt3))
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
  Do gt3 = 1, 3
Call CouplingcFeFeUAhL(gt1,gt2,gt3,Y1e11,Y1e22,Y1e21,Y2e33,ZEL,ZER,cplcFeFeUAhL(gt1,gt2,gt3)& 
...
Do gt1 = 1, 6
 Do gt2 = 1, 6
  Do gt3 = 1, 3
Call CouplingFvFvUAhL(gt1,gt2,gt3,Y1n11,Y1n22,Y1n12,Y2n33,C23,C32,Vv,cplFvFvUAhL(gt1,gt2,gt3)& 
& ,cplFvFvUAhR(gt1,gt2,gt3))
...
Do gt1 = 1, 6
 Do gt2 = 1, 3
  Do gt3 = 1, 2
Call CouplingFvFecUHmL(gt1,gt2,gt3,Y1e11,Y1e22,Y1e21,Y2e33,Y1n11,Y1n22,               & 
& Y1n12,Y2n33,ZEL,ZER,Vv,cplFvFecUHmL(gt1,gt2,gt3),cplFvFecUHmR(gt1,gt2,gt3))
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
  Do gt3 = 1, 3
Call CouplingcUFeFeAhL(gt1,gt2,gt3,Y1e11,Y1e22,Y1e21,Y2e33,ZA,ZEL,ZER,cplcUFeFeAhL(gt1,gt2,gt3)& 
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
  Do gt3 = 1, 3
Call CouplingcUFeFehhL(gt1,gt2,gt3,Y1e11,Y1e22,Y1e21,Y2e33,ZH,ZEL,ZER,cplcUFeFehhL(gt1,gt2,gt3)& 
...
Do gt1 = 1, 3
 Do gt2 = 1, 6
  Do gt3 = 1, 2
Call CouplingcUFeFvHmL(gt1,gt2,gt3,Y1e11,Y1e22,Y1e21,Y2e33,Y1n11,Y1n22,               & 
& Y1n12,Y2n33,ZP,Vv,cplcUFeFvHmL(gt1,gt2,gt3),cplcUFeFvHmR(gt1,gt2,gt3))
...
Do gt1 = 1, 6
 Do gt2 = 1, 6
  Do gt3 = 1, 3
Call CouplingUFvFvAhL(gt1,gt2,gt3,Y1n11,Y1n22,Y1n12,Y2n33,C23,C32,ZA,Vv,              & 
& cplUFvFvAhL(gt1,gt2,gt3),cplUFvFvAhR(gt1,gt2,gt3))
...
Do gt1 = 1, 6
 Do gt2 = 1, 3
  Do gt3 = 1, 2
Call CouplingUFvFecHmL(gt1,gt2,gt3,Y1e11,Y1e22,Y1e21,Y2e33,Y1n11,Y1n22,               & 
& Y1n12,Y2n33,ZP,ZEL,ZER,cplUFvFecHmL(gt1,gt2,gt3),cplUFvFecHmR(gt1,gt2,gt3))
...
Do gt1 = 1, 6
 Do gt2 = 1, 6
  Do gt3 = 1, 3
Call CouplingUFvFvhhL(gt1,gt2,gt3,Y1n11,Y1n22,Y1n12,Y2n33,C23,C32,ZH,Vv,              & 
& cplUFvFvhhL(gt1,gt2,gt3),cplUFvFvhhR(gt1,gt2,gt3))
...
Do gt1 = 1, 3
 Do gt2 = 1, 6
  Do gt3 = 1, 2
Call CouplingcFeUFvHmL(gt1,gt2,gt3,Y1e11,Y1e22,Y1e21,Y2e33,Y1n11,Y1n22,               & 
& Y1n12,Y2n33,ZP,ZEL,ZER,cplcFeUFvHmL(gt1,gt2,gt3),cplcFeUFvHmR(gt1,gt2,gt3))
...
Subroutine CouplingcFeFeUhhL(gt1,gt2,gt3,Y1e11,Y1e22,Y1e21,Y2e33,ZEL,ZER,             & 
& resL,resR)
...
Subroutine CouplingFvFvUhhL(gt1,gt2,gt3,Y1n11,Y1n22,Y1n12,Y2n33,C23,C32,              & 
& Vv,resL,resR)
...
Subroutine CouplingcFeFeUAhL(gt1,gt2,gt3,Y1e11,Y1e22,Y1e21,Y2e33,ZEL,ZER,             & 
& resL,resR)
...
Subroutine CouplingFvFvUAhL(gt1,gt2,gt3,Y1n11,Y1n22,Y1n12,Y2n33,C23,C32,              & 
& Vv,resL,resR)
...
Subroutine CouplingFvFecUHmL(gt1,gt2,gt3,Y1e11,Y1e22,Y1e21,Y2e33,Y1n11,               & 
& Y1n22,Y1n12,Y2n33,ZEL,ZER,Vv,resL,resR)

Implicit None 

Integer, Intent(in) :: gt1,gt2,gt3
Complex(dp), Intent(in) :: Y1e11,Y1e22,Y1e21,Y2e33,Y1n11,Y1n22,Y1n12,Y2n33,ZEL(3,3),ZER(3,3),Vv(6,6)
...
Subroutine CouplingcUFeFeAhL(gt1,gt2,gt3,Y1e11,Y1e22,Y1e21,Y2e33,ZA,ZEL,              & 
& ZER,resL,resR)
...
End If 
If ((1.eq.gt1)) Then 
resL = resL-((Y1e21*Conjg(ZEL(gt2,2))*ZA(gt3,2))/sqrt(2._dp))
End If 
If ((3.eq.gt1)) Then 
...
End If 
If ((2.eq.gt1)) Then 
resR = resR+(Conjg(Y1e21)*ZER(gt2,1)*ZA(gt3,2))/sqrt(2._dp)
End If 
If ((3.eq.gt1)) Then 
...
Subroutine CouplingcUFeFehhL(gt1,gt2,gt3,Y1e11,Y1e22,Y1e21,Y2e33,ZH,ZEL,              & 
& ZER,resL,resR)
...
End If 
If ((1.eq.gt1)) Then 
resL = resL-((Y1e21*Conjg(ZEL(gt2,2))*ZH(gt3,2))/sqrt(2._dp))
End If 
If ((3.eq.gt1)) Then 
...
End If 
If ((2.eq.gt1)) Then 
resR = resR-((Conjg(Y1e21)*ZER(gt2,1)*ZH(gt3,2))/sqrt(2._dp))
End If 
If ((3.eq.gt1)) Then 
...
Subroutine CouplingcUFeFvHmL(gt1,gt2,gt3,Y1e11,Y1e22,Y1e21,Y2e33,Y1n11,               & 
& Y1n22,Y1n12,Y2n33,ZP,Vv,resL,resR)

Implicit None 

Integer, Intent(in) :: gt1,gt2,gt3
Complex(dp), Intent(in) :: Y1e11,Y1e22,Y1e21,Y2e33,Y1n11,Y1n22,Y1n12,Y2n33,ZP(2,2),Vv(6,6)
...
End If 
If ((1.eq.gt1)) Then 
resL = resL-(Y1e21*Conjg(Vv(gt2,2))*Conjg(ZP(gt3,2)))
End If 
If ((2.eq.gt1)) Then 
...
End If 
If ((1.eq.gt1)) Then 
resR = resR+Conjg(Y1n12)*Conjg(ZP(gt3,2))*Vv(gt2,5)
End If 
If ((2.eq.gt1)) Then 
...
Subroutine CouplingUFvFvAhL(gt1,gt2,gt3,Y1n11,Y1n22,Y1n12,Y2n33,C23,C32,              & 
& ZA,Vv,resL,resR)
...
End If 
If ((1.eq.gt1)) Then 
resL = resL+(Y1n12*Conjg(Vv(gt2,5))*ZA(gt3,2))/sqrt(2._dp)
End If 
If ((3.eq.gt1)) Then 
resL = resL+(Y2n33*Conjg(Vv(gt2,6))*ZA(gt3,2))/sqrt(2._dp)
End If 
If ((5.eq.gt1)) Then 
resL = resL+(Y1n12*Conjg(Vv(gt2,1))*ZA(gt3,2))/sqrt(2._dp)
End If 
If ((6.eq.gt1)) Then 
...
End If 
If ((5.eq.gt1)) Then 
resR = resR-((Conjg(Y1n12)*Vv(gt2,1)*ZA(gt3,2))/sqrt(2._dp))
End If 
If ((6.eq.gt1)) Then 
resR = resR-((Conjg(Y2n33)*Vv(gt2,3)*ZA(gt3,2))/sqrt(2._dp))
End If 
If ((1.eq.gt1)) Then 
resR = resR-((Conjg(Y1n12)*Vv(gt2,5)*ZA(gt3,2))/sqrt(2._dp))
End If 
If ((3.eq.gt1)) Then 
...
Subroutine CouplingUFvFecHmL(gt1,gt2,gt3,Y1e11,Y1e22,Y1e21,Y2e33,Y1n11,               & 
& Y1n22,Y1n12,Y2n33,ZP,ZEL,ZER,resL,resR)

Implicit None 

Integer, Intent(in) :: gt1,gt2,gt3
Complex(dp), Intent(in) :: Y1e11,Y1e22,Y1e21,Y2e33,Y1n11,Y1n22,Y1n12,Y2n33,ZP(2,2),ZEL(3,3),ZER(3,3)
...
End If 
If ((5.eq.gt1)) Then 
resL = resL+Y1n12*Conjg(ZEL(gt2,1))*ZP(gt3,2)
End If 
If ((6.eq.gt1)) Then 
...
End If 
If ((2.eq.gt1)) Then 
resR = resR-(Conjg(Y1e21)*ZER(gt2,1)*ZP(gt3,2))
End If 
If ((3.eq.gt1)) Then 
...
Subroutine CouplingUFvFvhhL(gt1,gt2,gt3,Y1n11,Y1n22,Y1n12,Y2n33,C23,C32,              & 
& ZH,Vv,resL,resR)
...
End If 
If ((1.eq.gt1)) Then 
resL = resL-((Y1n12*Conjg(Vv(gt2,5))*ZH(gt3,2))/sqrt(2._dp))
End If 
If ((3.eq.gt1)) Then 
resL = resL-((Y2n33*Conjg(Vv(gt2,6))*ZH(gt3,2))/sqrt(2._dp))
End If 
If ((5.eq.gt1)) Then 
resL = resL-((Y1n12*Conjg(Vv(gt2,1))*ZH(gt3,2))/sqrt(2._dp))
End If 
If ((6.eq.gt1)) Then 
...
End If 
If ((5.eq.gt1)) Then 
resR = resR-((Conjg(Y1n12)*Vv(gt2,1)*ZH(gt3,2))/sqrt(2._dp))
End If 
If ((6.eq.gt1)) Then 
resR = resR-((Conjg(Y2n33)*Vv(gt2,3)*ZH(gt3,2))/sqrt(2._dp))
End If 
If ((1.eq.gt1)) Then 
resR = resR-((Conjg(Y1n12)*Vv(gt2,5)*ZH(gt3,2))/sqrt(2._dp))
End If 
If ((3.eq.gt1)) Then 
...
Subroutine CouplingcFeUFvHmL(gt1,gt2,gt3,Y1e11,Y1e22,Y1e21,Y2e33,Y1n11,               & 
& Y1n22,Y1n12,Y2n33,ZP,ZEL,ZER,resL,resR)
...
End If 
If ((2.eq.gt2)) Then 
resL = resL-(Y1e21*Conjg(ZER(gt1,1))*Conjg(ZP(gt3,2)))
End If 
If ((3.eq.gt2)) Then 
...
End If 
If ((5.eq.gt2)) Then 
resR = resR+Conjg(Y1n12)*Conjg(ZP(gt3,2))*ZEL(gt1,1)
End If 
If ((5.eq.gt2)) Then 
...
& ZUR,Y1e11,Y1e22,Y1e21,Y2e33,ZEL,ZER,Y1n11,Y1n22,Y1n12,Y2n33,Vv,cplcUFdFdAhL,           & 
...
& cplcUFeFvHmR,cplcUFeFvVWmL,cplcUFeFvVWmR)

Implicit None 
Real(dp), Intent(in) :: ZA(3,3),ZH(3,3),g3,g1,g2

Complex(dp), Intent(in) :: Y1d11,Y1d12,Y1d13,Y1d21,Y1d22,Y1d23,Y2d31,Y2d32,Y2d33,ZDL(3,3),ZDR(3,3),              & 
& ZZ(2,2),Y1u11,Y1u12,Y1u21,Y1u22,Y2u33,ZP(2,2),ZUL(3,3),ZUR(3,3),Y1e11,Y1e22,           & 
& Y1e21,Y2e33,ZEL(3,3),ZER(3,3),Y1n11,Y1n22,Y1n12,Y2n33,Vv(6,6)
...
& Y2d31,Y2d32,Y2d33,ZDL,ZDR,Y1e11,Y1e22,Y1e21,Y2e33,ZEL,ZER,Y1u11,Y1u12,Y1u21,           & 
& Y1u22,Y2u33,ZUL,ZUR,Y1n11,Y1n22,Y1n12,Y2n33,C23,C32,Vv,ZP,cplAhAhUhh,cplAhUhhhh,       & 
