...
& Aa1,Aa2,Mu1,Mu2,MuDash,Mub,Mu3,mGUT)
...
& Mu1,Mu2,MuDash,Mub,Mu3,mass_uncertainty_Q)
...
& Mu2,MuDash,Mub,Mu3,v1,v2,v3,Tpar,Spar,Upar,ae,amu,atau,EDMe,EDMmu,EDMtau,              &
...
& BB12,BB21,BB22,Aa1,Aa2,Mu1,Mu2,MuDash,Mub,Mu3,kont)
...
& Y2d33,Y1u11,Y1u12,Y1u21,Y1u22,Y2u33,Y1e11,Y1e12,Y1e21,Y1e22,Y2e33,Y1n11,               &
& Y1n12,Y1n21,Y1n22,Y2n33,C13,C23,C31,C32,BB11,BB12,BB21,BB22,Aa1,Aa2,Mu1,               &
& Mu2,MuDash,Mub,Mu3,deltaM,kont)
...
& Y1d11,Y1d12,Y1d13,Y1d21,Y1d22,Y1d23,Y2d31,Y2d32,Y2d33,Y1u11,Y1u12,Y1u21,               &
& Y1u22,Y2u33,Y1e11,Y1e12,Y1e21,Y1e22,Y2e33,Y1n11,Y1n12,Y1n21,Y1n22,Y2n33,               &
& C13,C23,C31,C32,BB11,BB12,BB21,BB22,Aa1,Aa2,Mu1,Mu2,MuDash,Mub,Mu3,mGut,               &
& kont,WriteOut,n_run)
...
& Aa2input,Mu1input,Mu2input,MuDashinput,Mubinput,Mu3input,mass_Qerror)
...
Real(dp) :: gD(99), Q, Qsave, Qstep, Qt, g_SM(62), mh_SM
...
Call ParametersToG99(g1,g2,g3,Lam1,Lam3,Lam4,Lam2,Lam1Dash,Lam2Dash,Lam3Dash,         &
...
If (iupdown.eq.1) Then
 tz=Log(Q/Qsave)
 dt=-tz/50._dp
 Call odeint(gD,99,0._dp,tz,0.1_dp*delta,dt,0._dp,rge99,kont)
Else
 tz=-Log(Q/Qsave)
 dt=tz/50._dp
 Call odeint(gD,99,tz,0._dp,0.1_dp*delta,dt,0._dp,rge99,kont)
End if
Call GToParameters99(gD,g1,g2,g3,Lam1,Lam3,Lam4,Lam2,Lam1Dash,Lam2Dash,               &
& Lam3Dash,Aa3,Aa4,Y1d11,Y1d12,Y1d13,Y1d21,Y1d22,Y1d23,Y2d31,Y2d32,Y2d33,Y1u11,          &
& Y1u12,Y1u21,Y1u22,Y2u33,Y1e11,Y1e12,Y1e21,Y1e22,Y2e33,Y1n11,Y1n12,Y1n21,               &
& Y1n22,Y2n33,C13,C23,C31,C32,BB11,BB12,BB21,BB22,Aa1,Aa2,Mu1,Mu2,MuDash,Mub,            &
& Mu3,v1,v2,v3)
