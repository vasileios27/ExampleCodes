...
vev2=mZ2_mZ*CosW2SinW2/(pi*alphamZ) -(2*v1**2 + 2*v2**2) 
vSM=Sqrt(vev2)
MuSM = 0.5_dp*Lambda_SM*vSM**2 
Yu_MZ(3,3)=mf_u(3)/vSM*Sqrt(2._dp) 
YuSM=Yu_MZ 
...
& Vv,ZA,ZH,ZP,ZW,ZZ,v1,v2,v3,g1,g2,g3,Lam1,Lam3,Lam4,Lam2,Lam1Dash,Lam2Dash,             & 
...
Complex(dp) :: cplAhhhVP(3,3),cplcFdFdVPL(3,3),cplcFdFdVPR(3,3),cplcFeFeVPL(3,3),cplcFeFeVPR(3,3),   & 
...
MHm2(1)=MVWm2
CosW2SinW2=(1._dp-sinW2_Q)*sinW2_Q
vev2=mZ2_Q*CosW2SinW2/(pi*alphaQ) -(2*v1**2 + 2*v2**2) 
vSM=Sqrt(vev2)
Call SetMatchingConditions(g1SM,g2SM,g3SM,YuSM,YdSM,YeSM,vSM,v1,v2,v3,g1,             & 
& g2,g3,Lam1,Lam3,Lam4,Lam2,Lam1Dash,Lam2Dash,Lam3Dash,Aa3,Aa4,Y1d11,Y1d12,              & 
& Y1d13,Y1d21,Y1d22,Y1d23,Y2d31,Y2d32,Y2d33,Y1u11,Y1u12,Y1u21,Y1u22,Y2u33,               & 
...
Call Pi1LoopVWm(mW2,MHm,MHm2,MAh,MAh2,MFu,MFu2,MFd,MFd2,MFv,MFv2,MFe,MFe2,            & 
...
CosW2SinW2=(1._dp-sinW2_Q)*sinW2_Q
If (IncludeDeltaVB) Then 
Call DeltaVB(sinW2,sinW2_Q,rho,MAh,MFe,MFv,Mhh,MHm,MVWm,BB11,BB12,BB21,               & 
& BB22,C13,C23,C31,C32,g2,ZER,v1,v2,ZEL,Vv,Y1e11,Y1e12,Y1e21,Y1e22,Y1n11,Y1n12,          & 
& Y1n21,Y1n22,Y2e33,Y2n33,ZA,ZH,ZP,delta)
...
vev2=4._dp*mz2_run/(g1SM**2+g2SM**2) -(2*v1**2 + 2*v2**2) 
vSM=sqrt(vev2) 
End If 
End Do
...
& Y1d13,Y1d21,Y1d22,Y1d23,Y2d31,Y2d32,Y2d33,Y1u11,Y1u12,Y1u21,Y1u22,Y2u33,               & 
& Y1e11,Y1e12,Y1e21,Y1e22,Y2e33,Y1n11,Y1n12,Y1n21,Y1n22,Y2n33,C13,C23,C31,               & 
& C32,BB11,BB12,BB21,BB22,Aa1,Aa2,Mu1,Mu2,MuDash,Mub,Mu3,.True.)
...
! Full one-loop corrections
Call CouplingsForSMfermions(Y1d11,Y1d12,Y1d13,Y1d21,Y1d22,Y1d23,Y2d31,Y2d32,          & 
& Y2d33,ZA,ZDL,ZDR,ZH,g3,g1,g2,ZZ,Y1u11,Y1u12,Y1u21,Y1u22,Y2u33,ZP,ZUL,ZUR,              & 
& Y1e11,Y1e12,Y1e21,Y1e22,Y2e33,ZEL,ZER,Y1n11,Y1n12,Y1n21,Y1n22,Y2n33,Vv,cplcUFdFdAhL,   & 
...
Call Sigma1LoopFeMZ(p2,MFe,MFe2,MAh,MAh2,Mhh,Mhh2,MVZ,MVZ2,MHm,MHm2,MFv,              & 
& MFv2,MVWm,MVWm2,cplcUFeFeAhL,cplcUFeFeAhR,cplcUFeFehhL,cplcUFeFehhR,cplcUFeFeVPL,      & 
...
Call CalculateMFe(Y1e11,Y1e12,Y1e21,Y1e22,Y2e33,v1,v2,ZEL,ZER,MFe,kont)
...
Call ParametersToG96(g1,g2,g3,Lam1,Lam3,Lam4,Lam2,Lam1Dash,Lam2Dash,Lam3Dash,         & 
...
& Y2n33,C13,C23,C31,C32,BB11,BB12,BB21,BB22,Aa1,Aa2,Mu1,Mu2,MuDash,Mub,Mu3,gMZ)
...
Real(dp) :: g_SM(62) 
Real(dp) :: delta0,deltaG0, gA(96), gB(96)
Real(dp) :: gC(99),  gD(99) 
Real(dp),Intent(out) :: mGUT
Complex(dp) :: Tad1Loop(3), lambda_SM, lambda_MZ 
Real(dp) :: comp(3), tanbQ, vev2 
Complex(dp) :: cplAhAhUhh(3,3,3),cplAhUhhhh(3,3,3),cplAhUhhVP(3,3),cplAhUhhVZ(3,3),cplcFdFdUhhL(3,3,3),& 
...
Real(dp) ::mass_new(23),mass_old(23),diff_m(23)
...
mGUT = 1._dp 
Call GToParameters96(gB,g1,g2,g3,Lam1,Lam3,Lam4,Lam2,Lam1Dash,Lam2Dash,               & 
& Lam3Dash,Aa3,Aa4,Y1d11,Y1d12,Y1d13,Y1d21,Y1d22,Y1d23,Y2d31,Y2d32,Y2d33,Y1u11,          & 
& Y1u12,Y1u21,Y1u22,Y2u33,Y1e11,Y1e12,Y1e21,Y1e22,Y2e33,Y1n11,Y1n12,Y1n21,               & 
...
Real(dp):: gA(96), gB(96), Scale_Save 
