...
MFe2 = MFe**2 
Call CalculateMFv(Y1n11,Y1n12,Y1n21,Y1n22,Y2n33,C13,C23,C31,C32,BB11,BB12,            & 
& BB21,BB22,v1,v2,v3,Vv,MFv,kont)
...
MFu2 = MFu**2 
Call CalculateMFeEffPot(Y1e11,Y1e12,Y1e21,Y1e22,Y2e33,v1,v2,ZEL,ZER,MFe,kont)

MFe2 = MFe**2 
Call CalculateMFvEffPot(Y1n11,Y1n12,Y1n21,Y1n22,Y2n33,C13,C23,C31,C32,BB11,           & 
& BB12,BB21,BB22,v1,v2,v3,Vv,MFv,kont)
...
Subroutine CalculateMFe(Y1e11,Y1e12,Y1e21,Y1e22,Y2e33,v1,v2,ZEL,ZER,MFe,kont)
...
mat(1,2) = 0._dp 
mat(1,2) = mat(1,2)+(v1*Y1e12)/sqrt(2._dp)
mat(1,3) = 0._dp 
mat(2,1) = 0._dp 
mat(2,1) = mat(2,1)+(v1*Y1e21)/sqrt(2._dp)
mat(2,2) = 0._dp 
...
Subroutine CalculateMFv(Y1n11,Y1n12,Y1n21,Y1n22,Y2n33,C13,C23,C31,C32,BB11,           & 
& BB12,BB21,BB22,v1,v2,v3,Vv,MFv,kont)
...
mat(1,5) = 0._dp 
mat(1,5) = mat(1,5)-((v1*Y1n12)/sqrt(2._dp))
mat(1,6) = 0._dp 
mat(2,2) = 0._dp 
mat(2,3) = 0._dp 
mat(2,4) = 0._dp 
mat(2,4) = mat(2,4)-((v1*Y1n21)/sqrt(2._dp))
mat(2,5) = 0._dp 
...
mat(4,4) = 0._dp 
mat(4,4) = mat(4,4)+(BB11*v3)/sqrt(2._dp)
mat(4,5) = 0._dp 
mat(4,5) = mat(4,5)-(BB12*v3)/(2._dp*sqrt(2._dp))
mat(4,5) = mat(4,5)-(BB21*v3)/(2._dp*sqrt(2._dp))
mat(4,6) = 0._dp 
mat(4,6) = mat(4,6)-(C13*v3)/(2._dp*sqrt(2._dp))
mat(4,6) = mat(4,6)-(C31*v3)/(2._dp*sqrt(2._dp))
mat(5,5) = 0._dp 
mat(5,5) = mat(5,5)-((BB22*v3)/sqrt(2._dp))
mat(5,6) = 0._dp 
...
Subroutine CalculateMFeEffPot(Y1e11,Y1e12,Y1e21,Y1e22,Y2e33,v1,v2,ZEL,ZER,MFe,kont)
...
Subroutine CalculateMFvEffPot(Y1n11,Y1n12,Y1n21,Y1n22,Y2n33,C13,C23,C31,              & 
& C32,BB11,BB12,BB21,BB22,v1,v2,v3,Vv,MFv,kont)
...
& Y2d31,Y2d32,Y2d33,Y1u11,Y1u12,Y1u21,Y1u22,Y2u33,Y1e11,Y1e12,Y1e21,Y1e22,               & 
& Y2e33,Y1n11,Y1n12,Y1n21,Y1n22,Y2n33,C13,C23,C31,C32,BB11,BB12,BB21,BB22,               & 
