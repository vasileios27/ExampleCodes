...
& cplhhVPVZ,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,BOddllSLL,           & 
...
Complex(dp),Intent(in) :: cplAhAhAh(3,3,3),cplAhAhhh(3,3,3),cplAhcHmVWm(3,2),cplAhhhhh(3,3,3),cplAhhhVP(3,3),   & 
...
& cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),cplcHmVPVWm(2),cplcHmVWmVZ(2),cplcVWmVPVWm,          & 
& cplcVWmVWmVZ,cplFvFecHmL(6,3,2),cplFvFecHmR(6,3,2),cplFvFecVWmL(6,3),cplFvFecVWmR(6,3),& 
& cplFvFvAhL(6,6,3),cplFvFvAhR(6,6,3),cplFvFvhhL(6,6,3),cplFvFvhhR(6,6,3),               & 
& cplFvFvVPL(6,6),cplFvFvVPR(6,6),cplFvFvVZL(6,6),cplFvFvVZR(6,6),cplhhcHmVWm(3,2),      & 
& cplhhcVWmVWm(3),cplhhhhhh(3,3,3),cplhhHmcHm(3,2,2),cplhhHmcVWm(3,2),cplhhVPVZ(3),      & 
& cplhhVZVZ(3),cplHmcHmVP(2,2),cplHmcHmVZ(2,2),cplHmcVWmVP(2),cplHmcVWmVZ(2)
...
coup4L = cplFvFecHmL(i3,gt3,i2)
coup4R = cplFvFecHmR(i3,gt3,i2)
mF1 = MFu(i1)
mF12 = MFu2(i1)
mS1 = MHm(i4)
mS12 = MHm2(i4)
...
coup3L = cplcFeFvHmL(gt4,i3,i4)
coup3R = cplcFeFvHmR(gt4,i3,i4)
coup4L = cplFvFecVWmL(i3,gt3)
coup4R = cplFvFecVWmR(i3,gt3)
mF1 = MFu(i1)
mF12 = MFu2(i1)
mS1 = MHm(i4)
mS12 = MHm2(i4)
...
& MFe,MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,cplAhAhAh,            & 
& cplAhAhhh,cplAhcHmVWm,cplAhhhhh,cplAhhhVP,cplAhhhVZ,cplAhHmcHm,cplAhHmcVWm,            & 
...
& cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,cplFvFecHmL,cplFvFecHmR,             & 
& cplFvFecVWmL,cplFvFecVWmR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVPL,      & 
& cplFvFvVPR,cplFvFvVZL,cplFvFvVZR,cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,        & 
& cplhhHmcVWm,cplhhVPVZ,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,         & 
...
End Do 
 ...
 ! Propagator: hh, Loop particles: Fv,Hm, Internal fermion: bar[Fe]
...
If (.not.OnlySM) Then 
coup1L = cplFvFecHmL(i1,gt3,i2)
coup1R = cplFvFecHmR(i1,gt3,i2)
coup2L = cplcFeFvHmL(i3,i1,i2)
coup2R = cplcFeFvHmR(i3,i1,i2)
coup3L = cplcFeFehhL(gt4,i3,iProp)
coup3R = cplcFeFehhR(gt4,i3,iProp)
coup4L = cplcFdFdhhL(gt2,gt1,iProp)
coup4R = cplcFdFdhhR(gt2,gt1,iProp)
...
End Do 
 ...
 ! Propagator: hh, Loop particles: Hm,Fv, Internal fermion: Fe
...
coup3L = cplcFeFehhL(i3,gt3,iProp)
coup3R = cplcFeFehhR(i3,gt3,iProp)
coup2L = cplFvFecHmL(i2,i3,i1)
coup2R = cplFvFecHmR(i2,i3,i1)
coup1L = cplcFeFvHmL(gt4,i2,i1)
coup1R = cplcFeFvHmR(gt4,i2,i1)
coup4L = cplcFdFdhhL(gt2,gt1,iProp)
coup4R = cplcFdFdhhR(gt2,gt1,iProp)
! Masses in loop
mS1 = MHm(i1)
...
End Do 
 ...
 ! Propagator: Ah, Loop particles: Fv,Hm, Internal fermion: bar[Fe]
! Generic diagram: FSF,  InsertionOrder: 7
chargefactor = 1 
Do iProp=1,3
Do i1=1,6
...
End Do 
 ...
 ! Propagator: Ah, Loop particles: Hm,Fv, Internal fermion: Fe
! Generic diagram: SFF,  InsertionOrder: 8
chargefactor = 1 
Do iProp=1,3
Do i1=1,2
...
End Do 
 ...
 ! Propagator: hh, Loop particles: Fv,Hm,Hm
...
coup1L = cplFvFecHmL(i1,gt3,i2)
coup1R = cplFvFecHmR(i1,gt3,i2)
coup2L = cplcFeFvHmL(gt4,i1,i3)
coup2R = cplcFeFvHmR(gt4,i1,i3)
coup3 = cplhhHmcHm(iProp,i2,i3)
coup4L = cplcFdFdhhL(gt2,gt1,iProp)
coup4R = cplcFdFdhhR(gt2,gt1,iProp)
! Masses in loop
...
End Do 
 ...
 ! Propagator: hh, Loop particles: Fv,VWm,Hm
...
End Do 
 ...
 ! Propagator: hh, Loop particles: Fv,Hm,VWm
...
End Do 
 ...
 ! Propagator: hh, Loop particles: conj[Hm],Fv,Fv
! Generic diagram: SFF,  InsertionOrder: 4
chargefactor = 1 
Do iProp=1,3
Do i1=1,2
...
If (.not.OnlySM) Then 
coup1L = cplFvFecHmL(i2,gt3,i1)
coup1R = cplFvFecHmR(i2,gt3,i1)
coup2L = cplcFeFvHmL(gt4,i3,i1)
coup2R = cplcFeFvHmR(gt4,i3,i1)
coup3L = cplFvFvhhL(i3,i2,iProp)
coup3R = cplFvFvhhR(i3,i2,iProp)
coup4L = cplcFdFdhhL(gt2,gt1,iProp)
coup4R = cplcFdFdhhR(gt2,gt1,iProp)
! Masses in loop
mS1 = MHm(i1)
...
End Do 
 ...
 ! Propagator: hh, Loop particles: conj[VWm],Fv,Fv
! Generic diagram: VFF,  InsertionOrder: 4
chargefactor = 1 
Do iProp=1,3
  Do i2=1,6
...
End Do 
 ...
 ! Propagator: Ah, Loop particles: Fv,Hm,Hm
! Generic diagram: FSS,  InsertionOrder: 4
chargefactor = 1 
Do iProp=1,3
Do i1=1,6
...
End Do 
 ...
 ! Propagator: Ah, Loop particles: Fv,VWm,Hm
! Generic diagram: FVS,  InsertionOrder: 4
chargefactor = 1 
Do iProp=1,3
Do i1=1,6
...
End Do 
 ...
 ! Propagator: Ah, Loop particles: Fv,Hm,VWm
! Generic diagram: FSV,  InsertionOrder: 4
chargefactor = 1 
Do iProp=1,3
Do i1=1,6
...
End Do 
 ...
 ! Propagator: Ah, Loop particles: conj[Hm],Fv,Fv
! Generic diagram: SFF,  InsertionOrder: 4
chargefactor = 1 
Do iProp=1,3
Do i1=1,2
...
coup2L = cplcFeFvHmL(gt4,i3,i1)
coup2R = cplcFeFvHmR(gt4,i3,i1)
coup3L = cplFvFvAhL(i3,i2,iProp)
coup3R = cplFvFvAhR(i3,i2,iProp)
coup4L = cplcFdFdAhL(gt2,gt1,iProp)
coup4R = cplcFdFdAhR(gt2,gt1,iProp)
! Masses in loop
mS1 = MHm(i1)
...
End Do 
 ...
 ! Propagator: Ah, Loop particles: conj[VWm],Fv,Fv
! Generic diagram: VFF,  InsertionOrder: 4
chargefactor = 1 
Do iProp=1,3
  Do i2=1,6
...
End if 
 ...
 ! Propagator: VZ, Loop particles: Fv,Hm, Internal fermion: bar[Fe]
! Generic diagram: FSF,  InsertionOrder: 7
chargefactor = 1 
Do i1=1,6
  Do i2=1,2
...
End if 
 ...
 ! Propagator: VZ, Loop particles: Hm,Fv, Internal fermion: Fe
! Generic diagram: SFF,  InsertionOrder: 8
chargefactor = 1 
Do i1=1,2
  Do i2=1,6
...
End if 
 ...
 ! Propagator: VZ, Loop particles: Fv,Hm,Hm
! Generic diagram: FSS,  InsertionOrder: 4
chargefactor = 1 
Do i1=1,6
  Do i2=1,2
...
End if 
 ...
 ! Propagator: VZ, Loop particles: Fv,VWm,Hm
! Generic diagram: FVS,  InsertionOrder: 4
chargefactor = 1 
Do i1=1,6
    Do i3=1,2
...
End if 
 ...
 ! Propagator: VZ, Loop particles: Fv,Hm,VWm
! Generic diagram: FSV,  InsertionOrder: 4
chargefactor = 1 
Do i1=1,6
  Do i2=1,2
...
End if 
 ...
 ! Propagator: VZ, Loop particles: conj[Hm],Fv,Fv
! Generic diagram: SFF,  InsertionOrder: 4
chargefactor = 1 
Do i1=1,2
  Do i2=1,6
...
& cplFvFecVWmR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVPL,cplFvFvVPR,        & 
& cplFvFvVZL,cplFvFvVZR,cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,       & 
& cplhhVPVZ,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,BOddvvVRR,           & 
...
Do i1=1,3
  Do i2=1,3
    Do i3=1,6
      Do i4=1,3
If ((MFd2(i1).gt.mf_l2(3)).Or.(MAh2(i2).gt.mf_l2(3)).Or.(MFv2(i3).gt.mf_l2(3)).Or.(MAh2(i4).gt.mf_l2(3))) Then
If (((i1.lt.4).and.(i3.lt.4).and.(i2.lt.2).and.(i4.lt.2)).or.(.not.OnlySM)) Then 
coup1L = cplcFdFdAhL(i1,gt1,i4)
coup1R = cplcFdFdAhR(i1,gt1,i4)
coup2L = cplcFdFdAhL(gt2,i1,i2)
coup2R = cplcFdFdAhR(gt2,i1,i2)
coup3L = cplFvFvAhL(gt3,i3,i4)
coup3R = cplFvFvAhR(gt3,i3,i4)
coup4L = cplFvFvAhL(gt4,i3,i2)
...
Do i1=1,3
    Do i3=1,6
      Do i4=1,3
If ((MFd2(i1).gt.mf_l2(3)).Or.(MVZ2.gt.mf_l2(3)).Or.(MFv2(i3).gt.mf_l2(3)).Or.(MAh2(i4).gt.mf_l2(3))) Then
If (((i1.lt.4).and.(i3.lt.4).and.(i4.lt.2)).or.(.not.OnlySM)) Then 
coup1L = cplcFdFdAhL(i1,gt1,i4)
coup1R = cplcFdFdAhR(i1,gt1,i4)
coup2L = cplcFdFdVZL(gt2,i1)
...
coup2L = cplcFdFdAhL(gt2,i1,i2)
coup2R = cplcFdFdAhR(gt2,i1,i2)
coup3L = cplFvFvhhL(gt3,i3,i4)
coup3R = cplFvFvhhR(gt3,i3,i4)
coup4L = cplFvFvAhL(gt4,i3,i2)
coup4R = cplFvFvAhR(gt4,i3,i2)
mF1 = MFd(i1)
mF12 = MFd2(i1)
...
Do i1=1,3
  Do i2=1,3
    Do i3=1,6
If ((MFd2(i1).gt.mf_l2(3)).Or.(MAh2(i2).gt.mf_l2(3)).Or.(MFv2(i3).gt.mf_l2(3)).Or.(MVZ2.gt.mf_l2(3))) Then
If (((i1.lt.4).and.(i3.lt.4).and.(i2.lt.2)).or.(.not.OnlySM)) Then 
coup1L = cplcFdFdVZL(i1,gt1)
coup1R = cplcFdFdVZR(i1,gt1)
coup2L = cplcFdFdAhL(gt2,i1,i2)
...
coup4L = cplFvFecHmL(gt4,i3,i2)
coup4R = cplFvFecHmR(gt4,i3,i2)
mF1 = MFu(i1)
mF12 = MFu2(i1)
mS1 = MHm(i4)
mS12 = MHm2(i4)
...
coup3L = cplcFeFvHmL(i3,gt3,i4)
coup3R = cplcFeFvHmR(i3,gt3,i4)
coup4L = cplFvFecVWmL(gt4,i3)
coup4R = cplFvFecVWmR(gt4,i3)
mF1 = MFu(i1)
mF12 = MFu2(i1)
mS1 = MHm(i4)
mS12 = MHm2(i4)
...
coup2L = cplcFdFdAhL(gt2,i1,i2)
coup2R = cplcFdFdAhR(gt2,i1,i2)
coup3L = cplFvFvAhL(gt4,i3,i4)
coup3R = cplFvFvAhR(gt4,i3,i4)
coup4L = cplFvFvAhL(gt3,i3,i2)
...
coup2L = cplcFdFdAhL(gt2,i1,i2)
coup2R = cplcFdFdAhR(gt2,i1,i2)
coup3L = cplFvFvhhL(gt4,i3,i4)
coup3R = cplFvFvhhR(gt4,i3,i4)
coup4L = cplFvFvAhL(gt3,i3,i2)
coup4R = cplFvFvAhR(gt3,i3,i2)
mF1 = MFd(i1)
mF12 = MFd2(i1)
...
coup2L = cplcFdFuHmL(gt2,i1,i2)
coup2R = cplcFdFuHmR(gt2,i1,i2)
coup3L = cplcFeFvHmL(i3,gt4,i4)
coup3R = cplcFeFvHmR(i3,gt4,i4)
coup4L = cplFvFecHmL(gt3,i3,i2)
coup4R = cplFvFecHmR(gt3,i3,i2)
mF1 = MFu(i1)
mF12 = MFu2(i1)
mS1 = MHm(i4)
mS12 = MHm2(i4)
...
coup3L = cplcFeFvHmL(i3,gt4,i4)
coup3R = cplcFeFvHmR(i3,gt4,i4)
coup4L = -cplFvFecVWmR(gt3,i3)
coup4R = -cplFvFecVWmL(gt3,i3)
mF1 = MFu(i1)
mF12 = MFu2(i1)
mS1 = MHm(i4)
mS12 = MHm2(i4)
...
coup2L = cplcFdFuHmL(gt2,i1,i2)
coup2R = cplcFdFuHmR(gt2,i1,i2)
coup3L = -cplcFeFvVWmR(i3,gt4)
coup3R = -cplcFeFvVWmL(i3,gt4)
coup4L = cplFvFecHmL(gt3,i3,i2)
coup4R = cplFvFecHmR(gt3,i3,i2)
mF1 = MFu(i1)
mF12 = MFu2(i1)
...
IMP2 = 1._dp/MP2 
! Amplitude 
  PSOddvvVRR=PSOddvvVRR+0.
  PSOddvvVLL=PSOddvvVLL+0.
  PSOddvvVRL=PSOddvvVRL+0.
  PSOddvvVLR=PSOddvvVLR+0.
     End if 
  End if 
End if 
    End Do 
...
End Do 
 ...
 ! Propagator: hh, Loop particles: Ah,Fv, Internal fermion: Fv
! Generic diagram: SFF,  InsertionOrder: 7
chargefactor = 1 
Do iProp=1,3
Do i1=1,3
  Do i2=1,6
    Do i3=1,6
If ((MAh2(i1).gt.mf_l2(3)).Or.(MFv2(i2).gt.mf_l2(3))) Then
If (.not.OnlySM) Then 
coup1L = cplFvFvAhL(gt3,i2,i1)
coup1R = cplFvFvAhR(gt3,i2,i1)
coup2L = cplFvFvAhL(i3,i2,i1)
coup2R = cplFvFvAhR(i3,i2,i1)
coup3L = cplFvFvhhL(gt4,i3,iProp)
coup3R = cplFvFvhhR(gt4,i3,iProp)
coup4L = cplcFdFdhhL(gt2,gt1,iProp)
coup4R = cplcFdFdhhR(gt2,gt1,iProp)
! Masses in loop
mS1 = MAh(i1)
...
End Do 
 ...
 ! Propagator: hh, Loop particles: Fe,Hm, Internal fermion: Fv
! Generic diagram: FSF,  InsertionOrder: 7
chargefactor = 1 
Do iProp=1,3
Do i1=1,3
...
If (.not.OnlySM) Then 
coup1L = cplFvFecHmL(gt3,i1,i2)
coup1R = cplFvFecHmR(gt3,i1,i2)
coup2L = cplcFeFvHmL(i1,i3,i2)
coup2R = cplcFeFvHmR(i1,i3,i2)
coup3L = cplFvFvhhL(gt4,i3,iProp)
coup3R = cplFvFvhhR(gt4,i3,iProp)
coup4L = cplcFdFdhhL(gt2,gt1,iProp)
coup4R = cplcFdFdhhR(gt2,gt1,iProp)
...
End Do 
 ...
 ! Propagator: hh, Loop particles: Fe,VWm, Internal fermion: Fv
! Generic diagram: FVF,  InsertionOrder: 7
chargefactor = 1 
Do iProp=1,3
Do i1=1,3
...
If (.not.OnlySM) Then 
coup1L = -cplFvFecVWmR(gt3,i1)
coup1R = -cplFvFecVWmL(gt3,i1)
...
End Do 
 ...
 ! Propagator: hh, Loop particles: Fv,hh, Internal fermion: Fv
! Generic diagram: FSF,  InsertionOrder: 7
chargefactor = 1 
Do iProp=1,3
Do i1=1,6
...
coup2L = cplFvFvhhL(i3,i1,i2)
coup2R = cplFvFvhhR(i3,i1,i2)
coup3L = cplFvFvhhL(gt4,i3,iProp)
coup3R = cplFvFvhhR(gt4,i3,iProp)
coup4L = cplcFdFdhhL(gt2,gt1,iProp)
coup4R = cplcFdFdhhR(gt2,gt1,iProp)
...
End Do 
 ...
 ! Propagator: hh, Loop particles: Fv,VZ, Internal fermion: Fv
! Generic diagram: FVF,  InsertionOrder: 7
chargefactor = 1 
Do iProp=1,3
Do i1=1,6
...
End Do 
 ...
 ! Propagator: hh, Loop particles: Hm,Fe, Internal fermion: Fv
! Generic diagram: SFF,  InsertionOrder: 7
chargefactor = 1 
Do iProp=1,3
Do i1=1,2
...
coup2L = cplFvFecHmL(i3,i2,i1)
coup2R = cplFvFecHmR(i3,i2,i1)
coup3L = cplFvFvhhL(gt4,i3,iProp)
coup3R = cplFvFvhhR(gt4,i3,iProp)
coup4L = cplcFdFdhhL(gt2,gt1,iProp)
coup4R = cplcFdFdhhR(gt2,gt1,iProp)
...
End Do 
 ...
 ! Propagator: hh, Loop particles: VWm,Fe, Internal fermion: Fv
! Generic diagram: VFF,  InsertionOrder: 7
chargefactor = 1 
Do iProp=1,3
  Do i2=1,3
...
End Do 
 ...
 ! Propagator: hh, Loop particles: Fv,Ah, Internal fermion: Fv
! Generic diagram: FSF,  InsertionOrder: 8
chargefactor = 1 
Do iProp=1,3
Do i1=1,6
  Do i2=1,3
    Do i3=1,6
If ((MFv2(i1).gt.mf_l2(3)).Or.(MAh2(i2).gt.mf_l2(3))) Then
If (.not.OnlySM) Then 
coup3L = cplFvFvhhL(gt3,i3,iProp)
coup3R = cplFvFvhhR(gt3,i3,iProp)
coup2L = cplFvFvAhL(i1,i3,i2)
coup2R = cplFvFvAhR(i1,i3,i2)
coup1L = cplFvFvAhL(gt4,i1,i2)
coup1R = cplFvFvAhR(gt4,i1,i2)
coup4L = cplcFdFdhhL(gt2,gt1,iProp)
coup4R = cplcFdFdhhR(gt2,gt1,iProp)
! Masses in loop
mF1 = MFv(i1)
...
coup2L = cplFvFecHmL(i3,i2,i1)
coup2R = cplFvFecHmR(i3,i2,i1)
coup1L = cplcFeFvHmL(i2,gt4,i1)
coup1R = cplcFeFvHmR(i2,gt4,i1)
coup4L = cplcFdFdhhL(gt2,gt1,iProp)
coup4R = cplcFdFdhhR(gt2,gt1,iProp)
! Masses in loop
mS1 = MHm(i1)
...
coup3L = cplFvFvhhL(gt3,i3,iProp)
coup3R = cplFvFvhhR(gt3,i3,iProp)
coup2L = -cplFvFecVWmR(i3,i2)
coup2R = -cplFvFecVWmL(i3,i2)
coup1L = -cplcFeFvVWmR(i2,gt4)
coup1R = -cplcFeFvVWmL(i2,gt4)
coup4L = cplcFdFdhhL(gt2,gt1,iProp)
coup4R = cplcFdFdhhR(gt2,gt1,iProp)
! Masses in loop
mV1 = MVWm
...
End Do 
 ...
 ! Propagator: hh, Loop particles: hh,Fv, Internal fermion: Fv
! Generic diagram: SFF,  InsertionOrder: 8
chargefactor = 1 
Do iProp=1,3
Do i1=1,3
...
coup3L = cplFvFvhhL(gt3,i3,iProp)
coup3R = cplFvFvhhR(gt3,i3,iProp)
coup2L = cplFvFvhhL(i2,i3,i1)
coup2R = cplFvFvhhR(i2,i3,i1)
coup1L = cplFvFvhhL(gt4,i2,i1)
coup1R = cplFvFvhhR(gt4,i2,i1)
coup4L = cplcFdFdhhL(gt2,gt1,iProp)
coup4R = cplcFdFdhhR(gt2,gt1,iProp)
! Masses in loop
mS1 = Mhh(i1)
...
End Do 
 ...
 ! Propagator: hh, Loop particles: VZ,Fv, Internal fermion: Fv
! Generic diagram: VFF,  InsertionOrder: 8
chargefactor = 1 
Do iProp=1,3
  Do i2=1,6
...
coup2L = cplcFeFvHmL(i1,i3,i2)
coup2R = cplcFeFvHmR(i1,i3,i2)
coup1L = cplFvFecHmL(gt4,i1,i2)
coup1R = cplFvFecHmR(gt4,i1,i2)
coup4L = cplcFdFdhhL(gt2,gt1,iProp)
coup4R = cplcFdFdhhR(gt2,gt1,iProp)
! Masses in loop
mF1 = MFe(i1)
...
End Do 
 ...
 ! Propagator: Ah, Loop particles: Ah,Fv, Internal fermion: Fv
! Generic diagram: SFF,  InsertionOrder: 7
chargefactor = 1 
Do iProp=1,3
Do i1=1,3
...
coup2L = cplFvFvAhL(i3,i2,i1)
coup2R = cplFvFvAhR(i3,i2,i1)
coup3L = cplFvFvAhL(gt4,i3,iProp)
coup3R = cplFvFvAhR(gt4,i3,iProp)
coup4L = cplcFdFdAhL(gt2,gt1,iProp)
coup4R = cplcFdFdAhR(gt2,gt1,iProp)
! Masses in loop
mS1 = MAh(i1)
...
End Do 
 ...
 ! Propagator: Ah, Loop particles: Fe,Hm, Internal fermion: Fv
! Generic diagram: FSF,  InsertionOrder: 7
chargefactor = 1 
Do iProp=1,3
Do i1=1,3
...
End Do 
 ...
 ! Propagator: Ah, Loop particles: Fe,VWm, Internal fermion: Fv
! Generic diagram: FVF,  InsertionOrder: 7
chargefactor = 1 
Do iProp=1,3
Do i1=1,3
...
End Do 
 ...
 ! Propagator: Ah, Loop particles: Fv,hh, Internal fermion: Fv
! Generic diagram: FSF,  InsertionOrder: 7
chargefactor = 1 
Do iProp=1,3
Do i1=1,6
...
End Do 
 ...
 ! Propagator: Ah, Loop particles: Fv,VZ, Internal fermion: Fv
! Generic diagram: FVF,  InsertionOrder: 7
chargefactor = 1 
Do iProp=1,3
Do i1=1,6
...
End Do 
 ...
 ! Propagator: Ah, Loop particles: Hm,Fe, Internal fermion: Fv
! Generic diagram: SFF,  InsertionOrder: 7
chargefactor = 1 
Do iProp=1,3
Do i1=1,2
...
End Do 
 ...
 ! Propagator: Ah, Loop particles: VWm,Fe, Internal fermion: Fv
! Generic diagram: VFF,  InsertionOrder: 7
chargefactor = 1 
Do iProp=1,3
  Do i2=1,3
...
End Do 
 ...
 ! Propagator: Ah, Loop particles: Fv,Ah, Internal fermion: Fv
! Generic diagram: FSF,  InsertionOrder: 8
chargefactor = 1 
Do iProp=1,3
Do i1=1,6
...
End Do 
 ...
 ! Propagator: Ah, Loop particles: hh,Fv, Internal fermion: Fv
! Generic diagram: SFF,  InsertionOrder: 8
chargefactor = 1 
Do iProp=1,3
Do i1=1,3
...
End Do 
 ...
 ! Propagator: Ah, Loop particles: VZ,Fv, Internal fermion: Fv
! Generic diagram: VFF,  InsertionOrder: 8
chargefactor = 1 
Do iProp=1,3
  Do i2=1,6
...
End Do 
 ...
 ! Propagator: hh, Loop particles: Ah,Fv,Fv
! Generic diagram: SFF,  InsertionOrder: 4
chargefactor = 1 
Do iProp=1,3
Do i1=1,3
  Do i2=1,6
    Do i3=1,6
If ((MAh2(i1).gt.mf_l2(3)).Or.(MFv2(i2).gt.mf_l2(3)).Or.(MFv2(i3).gt.mf_l2(3))) Then
If (.not.OnlySM) Then 
coup1L = cplFvFvAhL(gt3,i2,i1)
coup1R = cplFvFvAhR(gt3,i2,i1)
coup2L = cplFvFvAhL(gt4,i3,i1)
coup2R = cplFvFvAhR(gt4,i3,i1)
coup3L = cplFvFvhhL(i3,i2,iProp)
coup3R = cplFvFvhhR(i3,i2,iProp)
coup4L = cplcFdFdhhL(gt2,gt1,iProp)
coup4R = cplcFdFdhhR(gt2,gt1,iProp)
...
End Do 
 ...
 ! Propagator: hh, Loop particles: Fe,Hm,Hm
! Generic diagram: FSS,  InsertionOrder: 4
chargefactor = 1 
Do iProp=1,3
Do i1=1,3
...
coup1L = cplFvFecHmL(gt3,i1,i2)
coup1R = cplFvFecHmR(gt3,i1,i2)
coup2L = cplcFeFvHmL(i1,gt4,i3)
coup2R = cplcFeFvHmR(i1,gt4,i3)
coup3 = cplhhHmcHm(iProp,i2,i3)
coup4L = cplcFdFdhhL(gt2,gt1,iProp)
coup4R = cplcFdFdhhR(gt2,gt1,iProp)
! Masses in loop
...
End Do 
 ...
 ! Propagator: hh, Loop particles: Fe,VWm,Hm
! Generic diagram: FVS,  InsertionOrder: 4
chargefactor = 1 
Do iProp=1,3
Do i1=1,3
...
End Do 
 ...
 ! Propagator: hh, Loop particles: Fe,Hm,VWm
! Generic diagram: FSV,  InsertionOrder: 4
chargefactor = 1 
Do iProp=1,3
Do i1=1,3
...
coup1L = cplFvFecHmL(gt3,i1,i2)
coup1R = cplFvFecHmR(gt3,i1,i2)
coup2L = -cplcFeFvVWmR(i1,gt4)
coup2R = -cplcFeFvVWmL(i1,gt4)
coup3 = -cplhhHmcVWm(iProp,i2)
coup4L = cplcFdFdhhL(gt2,gt1,iProp)
coup4R = cplcFdFdhhR(gt2,gt1,iProp)
! Masses in loop
...
End Do 
 ...
 ! Propagator: hh, Loop particles: Fe,VWm,VWm
! Generic diagram: FVV,  InsertionOrder: 4
chargefactor = 1 
Do iProp=1,3
Do i1=1,3
...
End Do 
 ...
 ! Propagator: hh, Loop particles: Fv,Ah,Ah
! Generic diagram: FSS,  InsertionOrder: 4
chargefactor = 1 
Do iProp=1,3
Do i1=1,6
  Do i2=1,3
    Do i3=1,3
If ((MFv2(i1).gt.mf_l2(3)).Or.(MAh2(i2).gt.mf_l2(3)).Or.(MAh2(i3).gt.mf_l2(3))) Then
If (.not.OnlySM) Then 
coup1L = cplFvFvAhL(gt3,i1,i2)
coup1R = cplFvFvAhR(gt3,i1,i2)
coup2L = cplFvFvAhL(gt4,i1,i3)
coup2R = cplFvFvAhR(gt4,i1,i3)
coup3 = cplAhAhhh(i3,i2,iProp)
coup4L = cplcFdFdhhL(gt2,gt1,iProp)
coup4R = cplcFdFdhhR(gt2,gt1,iProp)
! Masses in loop
...
End Do 
 ...
 ! Propagator: hh, Loop particles: Fv,hh,Ah
! Generic diagram: FSS,  InsertionOrder: 4
chargefactor = 1 
Do iProp=1,3
Do i1=1,6
...
End Do 
 ...
 ! Propagator: hh, Loop particles: Fv,VZ,Ah
! Generic diagram: FVS,  InsertionOrder: 4
chargefactor = 1 
Do iProp=1,3
Do i1=1,6
    Do i3=1,3
If ((MFv2(i1).gt.mf_l2(3)).Or.(MVZ2.gt.mf_l2(3)).Or.(MAh2(i3).gt.mf_l2(3))) Then
If (.not.OnlySM) Then 
coup1L = cplFvFvVZL(gt3,i1)
coup1R = cplFvFvVZR(gt3,i1)
coup2L = cplFvFvAhL(gt4,i1,i3)
...
End Do 
 ...
 ! Propagator: hh, Loop particles: Fv,Ah,hh
! Generic diagram: FSS,  InsertionOrder: 4
chargefactor = 1 
Do iProp=1,3
Do i1=1,6
...
coup1L = cplFvFvAhL(gt3,i1,i2)
coup1R = cplFvFvAhR(gt3,i1,i2)
coup2L = cplFvFvhhL(gt4,i1,i3)
coup2R = cplFvFvhhR(gt4,i1,i3)
coup3 = cplAhhhhh(i2,iProp,i3)
coup4L = cplcFdFdhhL(gt2,gt1,iProp)
coup4R = cplcFdFdhhR(gt2,gt1,iProp)
! Masses in loop
...
End Do 
 ...
 ! Propagator: hh, Loop particles: Fv,hh,hh
! Generic diagram: FSS,  InsertionOrder: 4
chargefactor = 1 
Do iProp=1,3
Do i1=1,6
...
End Do 
 ...
 ! Propagator: hh, Loop particles: Fv,Ah,VZ
! Generic diagram: FSV,  InsertionOrder: 4
chargefactor = 1 
Do iProp=1,3
Do i1=1,6
  Do i2=1,3
If ((MFv2(i1).gt.mf_l2(3)).Or.(MAh2(i2).gt.mf_l2(3)).Or.(MVZ2.gt.mf_l2(3))) Then
If (.not.OnlySM) Then 
coup1L = cplFvFvAhL(gt3,i1,i2)
coup1R = cplFvFvAhR(gt3,i1,i2)
coup2L = cplFvFvVZL(gt4,i1)
coup2R = cplFvFvVZR(gt4,i1)
coup3 = cplAhhhVZ(i2,iProp)
coup4L = cplcFdFdhhL(gt2,gt1,iProp)
coup4R = cplcFdFdhhR(gt2,gt1,iProp)
! Masses in loop
...
End Do 
 ...
 ! Propagator: hh, Loop particles: Fv,VZ,VZ
! Generic diagram: FVV,  InsertionOrder: 4
chargefactor = 1 
Do iProp=1,3
Do i1=1,6
If ((MFv2(i1).gt.mf_l2(3)).Or.(MVZ2.gt.mf_l2(3)).Or.(MVZ2.gt.mf_l2(3))) Then
If (.not.OnlySM) Then 
coup1L = cplFvFvVZL(gt3,i1)
coup1R = cplFvFvVZR(gt3,i1)
coup2L = cplFvFvVZL(gt4,i1)
...
End Do 
 ...
 ! Propagator: hh, Loop particles: hh,Fv,Fv
! Generic diagram: SFF,  InsertionOrder: 4
chargefactor = 1 
Do iProp=1,3
Do i1=1,3
...
coup2L = cplFvFvhhL(gt4,i3,i1)
coup2R = cplFvFvhhR(gt4,i3,i1)
coup3L = cplFvFvhhL(i3,i2,iProp)
coup3R = cplFvFvhhR(i3,i2,iProp)
coup4L = cplcFdFdhhL(gt2,gt1,iProp)
coup4R = cplcFdFdhhR(gt2,gt1,iProp)
...
End Do 
 ...
 ! Propagator: hh, Loop particles: Hm,Fe,Fe
! Generic diagram: SFF,  InsertionOrder: 4
chargefactor = 1 
Do iProp=1,3
Do i1=1,2
...
coup1L = cplcFeFvHmL(i2,gt3,i1)
coup1R = cplcFeFvHmR(i2,gt3,i1)
coup2L = cplFvFecHmL(gt4,i3,i1)
coup2R = cplFvFecHmR(gt4,i3,i1)
coup3L = cplcFeFehhL(i3,i2,iProp)
coup3R = cplcFeFehhR(i3,i2,iProp)
coup4L = cplcFdFdhhL(gt2,gt1,iProp)
coup4R = cplcFdFdhhR(gt2,gt1,iProp)
...
End Do 
 ...
 ! Propagator: hh, Loop particles: VWm,Fe,Fe
! Generic diagram: VFF,  InsertionOrder: 4
chargefactor = 1 
Do iProp=1,3
  Do i2=1,3
...
End Do 
 ...
 ! Propagator: hh, Loop particles: VZ,Fv,Fv
! Generic diagram: VFF,  InsertionOrder: 4
chargefactor = 1 
Do iProp=1,3
  Do i2=1,6
...
End Do 
 ...
 ! Propagator: hh, Loop particles: bar[Fe],conj[Hm],conj[Hm]
! Generic diagram: FSS,  InsertionOrder: 4
chargefactor = 1 
Do iProp=1,3
Do i1=1,3
...
coup2L = cplFvFecHmL(gt4,i1,i3)
coup2R = cplFvFecHmR(gt4,i1,i3)
...
End Do 
 ...
 ! Propagator: hh, Loop particles: bar[Fe],conj[VWm],conj[Hm]
! Generic diagram: FVS,  InsertionOrder: 4
chargefactor = 1 
Do iProp=1,3
Do i1=1,3
...
End Do 
 ...
 ! Propagator: hh, Loop particles: bar[Fe],conj[Hm],conj[VWm]
! Generic diagram: FSV,  InsertionOrder: 4
chargefactor = 1 
Do iProp=1,3
Do i1=1,3
...
End Do 
 ...
 ! Propagator: hh, Loop particles: bar[Fe],conj[VWm],conj[VWm]
! Generic diagram: FVV,  InsertionOrder: 4
chargefactor = 1 
Do iProp=1,3
Do i1=1,3
...
End Do 
 ...
 ! Propagator: hh, Loop particles: conj[Hm],bar[Fe],bar[Fe]
! Generic diagram: SFF,  InsertionOrder: 4
chargefactor = 1 
Do iProp=1,3
Do i1=1,2
...
If ((MHm2(i1).gt.mf_l2(3)).Or.(MFe2(i2).gt.mf_l2(3)).Or.(MFe2(i3).gt.mf_l2(3))) Then
If (.not.OnlySM) Then 
coup1L = cplFvFecHmL(gt3,i2,i1)
coup1R = cplFvFecHmR(gt3,i2,i1)
coup2L = cplcFeFvHmL(i3,gt4,i1)
coup2R = cplcFeFvHmR(i3,gt4,i1)
coup3L = cplcFeFehhL(i2,i3,iProp)
coup3R = cplcFeFehhR(i2,i3,iProp)
coup4L = cplcFdFdhhL(gt2,gt1,iProp)
coup4R = cplcFdFdhhR(gt2,gt1,iProp)
! Masses in loop
mS1 = MHm(i1)
...
End Do 
 ...
 ! Propagator: hh, Loop particles: conj[VWm],bar[Fe],bar[Fe]
! Generic diagram: VFF,  InsertionOrder: 4
chargefactor = 1 
Do iProp=1,3
  Do i2=1,3
...
If ((MVWm2.gt.mf_l2(3)).Or.(MFe2(i2).gt.mf_l2(3)).Or.(MFe2(i3).gt.mf_l2(3))) Then
If (.not.OnlySM) Then 
coup1L = -cplFvFecVWmR(gt3,i2)
coup1R = -cplFvFecVWmL(gt3,i2)
coup2L = -cplcFeFvVWmR(i3,gt4)
coup2R = -cplcFeFvVWmL(i3,gt4)
coup3L = cplcFeFehhL(i2,i3,iProp)
coup3R = cplcFeFehhR(i2,i3,iProp)
coup4L = cplcFdFdhhL(gt2,gt1,iProp)
coup4R = cplcFdFdhhR(gt2,gt1,iProp)
...
End Do 
 ...
 ! Propagator: Ah, Loop particles: Ah,Fv,Fv
! Generic diagram: SFF,  InsertionOrder: 4
chargefactor = 1 
Do iProp=1,3
Do i1=1,3
...
End Do 
 ...
 ! Propagator: Ah, Loop particles: Fe,Hm,Hm
! Generic diagram: FSS,  InsertionOrder: 4
chargefactor = 1 
Do iProp=1,3
Do i1=1,3
...
End Do 
 ...
 ! Propagator: Ah, Loop particles: Fe,VWm,Hm
! Generic diagram: FVS,  InsertionOrder: 4
chargefactor = 1 
Do iProp=1,3
Do i1=1,3
...
End Do 
 ...
 ! Propagator: Ah, Loop particles: Fe,Hm,VWm
! Generic diagram: FSV,  InsertionOrder: 4
chargefactor = 1 
Do iProp=1,3
Do i1=1,3
...
End Do 
 ...
 ! Propagator: Ah, Loop particles: Fv,Ah,Ah
! Generic diagram: FSS,  InsertionOrder: 4
chargefactor = 1 
Do iProp=1,3
Do i1=1,6
...
End Do 
 ...
 ! Propagator: Ah, Loop particles: Fv,hh,Ah
! Generic diagram: FSS,  InsertionOrder: 4
chargefactor = 1 
Do iProp=1,3
Do i1=1,6
...
End Do 
 ...
 ! Propagator: Ah, Loop particles: Fv,Ah,hh
! Generic diagram: FSS,  InsertionOrder: 4
chargefactor = 1 
Do iProp=1,3
Do i1=1,6
...
End Do 
 ...
 ! Propagator: Ah, Loop particles: Fv,hh,hh
! Generic diagram: FSS,  InsertionOrder: 4
chargefactor = 1 
Do iProp=1,3
Do i1=1,6
...
End Do 
 ...
 ! Propagator: Ah, Loop particles: Fv,VZ,hh
! Generic diagram: FVS,  InsertionOrder: 4
chargefactor = 1 
Do iProp=1,3
Do i1=1,6
...
End Do 
 ...
 ! Propagator: Ah, Loop particles: Fv,hh,VZ
! Generic diagram: FSV,  InsertionOrder: 4
chargefactor = 1 
Do iProp=1,3
Do i1=1,6
...
End Do 
 ...
 ! Propagator: Ah, Loop particles: hh,Fv,Fv
! Generic diagram: SFF,  InsertionOrder: 4
chargefactor = 1 
Do iProp=1,3
Do i1=1,3
...
End Do 
 ...
 ! Propagator: Ah, Loop particles: Hm,Fe,Fe
! Generic diagram: SFF,  InsertionOrder: 4
chargefactor = 1 
Do iProp=1,3
Do i1=1,2
...
End Do 
 ...
 ! Propagator: Ah, Loop particles: VWm,Fe,Fe
! Generic diagram: VFF,  InsertionOrder: 4
chargefactor = 1 
Do iProp=1,3
  Do i2=1,3
...
End Do 
 ...
 ! Propagator: Ah, Loop particles: VZ,Fv,Fv
! Generic diagram: VFF,  InsertionOrder: 4
chargefactor = 1 
Do iProp=1,3
  Do i2=1,6
...
End Do 
 ...
 ! Propagator: Ah, Loop particles: bar[Fe],conj[Hm],conj[Hm]
! Generic diagram: FSS,  InsertionOrder: 4
chargefactor = 1 
Do iProp=1,3
Do i1=1,3
...
End Do 
 ...
 ! Propagator: Ah, Loop particles: bar[Fe],conj[VWm],conj[Hm]
! Generic diagram: FVS,  InsertionOrder: 4
chargefactor = 1 
Do iProp=1,3
Do i1=1,3
...
End Do 
 ...
 ! Propagator: Ah, Loop particles: bar[Fe],conj[Hm],conj[VWm]
! Generic diagram: FSV,  InsertionOrder: 4
chargefactor = 1 
Do iProp=1,3
Do i1=1,3
...
End Do 
 ...
 ! Propagator: Ah, Loop particles: conj[Hm],bar[Fe],bar[Fe]
! Generic diagram: SFF,  InsertionOrder: 4
chargefactor = 1 
Do iProp=1,3
Do i1=1,2
...
coup2L = cplcFeFvHmL(i3,gt4,i1)
coup2R = cplcFeFvHmR(i3,gt4,i1)
coup3L = cplcFeFeAhL(i2,i3,iProp)
coup3R = cplcFeFeAhR(i2,i3,iProp)
coup4L = cplcFdFdAhL(gt2,gt1,iProp)
coup4R = cplcFdFdAhR(gt2,gt1,iProp)
! Masses in loop
mS1 = MHm(i1)
...
End Do 
 ...
 ! Propagator: Ah, Loop particles: conj[VWm],bar[Fe],bar[Fe]
! Generic diagram: VFF,  InsertionOrder: 4
chargefactor = 1 
Do iProp=1,3
  Do i2=1,3
...
End if 
 ...
 ! Propagator: VZ, Loop particles: Ah,Fv, Internal fermion: Fv
! Generic diagram: SFF,  InsertionOrder: 7
chargefactor = 1 
Do i1=1,3
  Do i2=1,6
...
End if 
 ...
 ! Propagator: VZ, Loop particles: Fe,Hm, Internal fermion: Fv
! Generic diagram: FSF,  InsertionOrder: 7
chargefactor = 1 
Do i1=1,3
  Do i2=1,2
...
End if 
 ...
 ! Propagator: VZ, Loop particles: Fv,hh, Internal fermion: Fv
! Generic diagram: FSF,  InsertionOrder: 7
chargefactor = 1 
Do i1=1,6
  Do i2=1,3
...
End if 
 ...
 ! Propagator: VZ, Loop particles: Hm,Fe, Internal fermion: Fv
! Generic diagram: SFF,  InsertionOrder: 7
chargefactor = 1 
Do i1=1,2
  Do i2=1,3
...
End if 
 ...
 ! Propagator: VZ, Loop particles: Fv,Ah, Internal fermion: Fv
! Generic diagram: FSF,  InsertionOrder: 8
chargefactor = 1 
Do i1=1,6
  Do i2=1,3
...
End if 
 ...
 ! Propagator: VZ, Loop particles: hh,Fv, Internal fermion: Fv
! Generic diagram: SFF,  InsertionOrder: 8
chargefactor = 1 
Do i1=1,3
  Do i2=1,6
...
End if 
 ...
 ! Propagator: VZ, Loop particles: Ah,Fv,Fv
! Generic diagram: SFF,  InsertionOrder: 4
chargefactor = 1 
Do i1=1,3
  Do i2=1,6
...
End if 
 ...
 ! Propagator: VZ, Loop particles: Fe,Hm,Hm
! Generic diagram: FSS,  InsertionOrder: 4
chargefactor = 1 
Do i1=1,3
  Do i2=1,2
...
End if 
 ...
 ! Propagator: VZ, Loop particles: Fe,VWm,Hm
! Generic diagram: FVS,  InsertionOrder: 4
chargefactor = 1 
Do i1=1,3
    Do i3=1,2
...
End if 
 ...
 ! Propagator: VZ, Loop particles: Fe,Hm,VWm
! Generic diagram: FSV,  InsertionOrder: 4
chargefactor = 1 
Do i1=1,3
  Do i2=1,2
...
End if 
 ...
 ! Propagator: VZ, Loop particles: Fv,hh,Ah
! Generic diagram: FSS,  InsertionOrder: 4
chargefactor = 1 
Do i1=1,6
  Do i2=1,3
...
End if 
 ...
 ! Propagator: VZ, Loop particles: Fv,Ah,hh
! Generic diagram: FSS,  InsertionOrder: 4
chargefactor = 1 
Do i1=1,6
  Do i2=1,3
...
End if 
 ...
 ! Propagator: VZ, Loop particles: Fv,VZ,hh
! Generic diagram: FVS,  InsertionOrder: 4
chargefactor = 1 
Do i1=1,6
    Do i3=1,3
...
End if 
 ...
 ! Propagator: VZ, Loop particles: Fv,hh,VZ
! Generic diagram: FSV,  InsertionOrder: 4
chargefactor = 1 
Do i1=1,6
  Do i2=1,3
...
End if 
 ...
 ! Propagator: VZ, Loop particles: hh,Fv,Fv
! Generic diagram: SFF,  InsertionOrder: 4
chargefactor = 1 
Do i1=1,3
  Do i2=1,6
...
End if 
 ...
 ! Propagator: VZ, Loop particles: conj[Hm],bar[Fe],bar[Fe]
! Generic diagram: SFF,  InsertionOrder: 4
chargefactor = 1 
Do i1=1,2
  Do i2=1,3
...
IMP2 = 1._dp/MP2 
! Amplitude 
  TSOddvvVRR=TSOddvvVRR+ 0.
  TSOddvvVLL=TSOddvvVLL+ 0.
  TSOddvvVRL=TSOddvvVRL+ 0.
  TSOddvvVLR=TSOddvvVLR+ 0.
 End if 
End Do 
...
coup1L = cplcFdFdAhL(gt2,gt1,iProp)
coup1R = cplcFdFdAhR(gt2,gt1,iProp)
coup2L = cplFvFvAhL(gt3,gt4,iProp)
coup2R = cplFvFvAhR(gt3,gt4,iProp)
! Propagator and inverse propagator mass 
MP = MAh(iProp)
MP2 = MAh2(iProp)
IMP = 1._dp/MP  
...
& cplAhhhhh,cplAhhhVP,cplAhhhVZ,cplAhHmcHm,cplAhHmcVWm,cplcFdFdAhL,cplcFdFdAhR,          & 
...
& cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,BO4dSLL,BO4dSRR,BO4dSRL,BO4dSLR,         & 
& BO4dVRR,BO4dVLL,BO4dVRL,BO4dVLR,BO4dTLL,BO4dTLR,BO4dTRL,BO4dTRR)
...
Implicit None 
Real(dp),Intent(in) :: MAh(3),MAh2(3),MFd(3),MFd2(3),MFu(3),MFu2(3),Mhh(3),Mhh2(3),MHm(2),MHm2(2),           & 
& MVWm,MVWm2,MVZ,MVZ2
...
& cplcFuFdcHmR(3,3,2),cplcFuFdcVWmL(3,3),cplcFuFdcVWmR(3,3),cplcFuFuAhL(3,3,3),          & 
...
& cplcHmVPVWm(2),cplcHmVWmVZ(2),cplcVWmVPVWm,cplcVWmVWmVZ,cplhhcHmVWm(3,2),              & 
& cplhhcVWmVWm(3),cplhhhhhh(3,3,3),cplhhHmcHm(3,2,2),cplhhHmcVWm(3,2),cplhhVPVZ(3),      & 
& cplhhVZVZ(3),cplHmcHmVP(2,2),cplHmcHmVZ(2,2),cplHmcVWmVP(2),cplHmcVWmVZ(2)
...
& cplcFuFuVZL,cplcFuFuVZR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,             & 
& cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,cplhhVPVZ,cplhhVZVZ,         & 
& cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,TSO4dSLL,TSO4dSRR,TSO4dSRL,              & 
& TSO4dSLR,TSO4dVRR,TSO4dVLL,TSO4dVRL,TSO4dVLR,TSO4dTLL,TSO4dTLR,TSO4dTRL,TSO4dTRR)
...
& cplcFuFuVZL,cplcFuFuVZR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,             & 
& cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,cplhhVPVZ,cplhhVZVZ,         & 
& cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,TVO4dSLL,TVO4dSRR,TVO4dSRL,              & 
& TVO4dSLR,TVO4dVRR,TVO4dVLL,TVO4dVRL,TVO4dVLR,TVO4dTLL,TVO4dTLR,TVO4dTRL,TVO4dTRR)
...
Complex(dp),Intent(in) :: cplAhAhAh(3,3,3),cplAhAhhh(3,3,3),cplAhcHmVWm(3,2),cplAhhhhh(3,3,3),cplAhhhVZ(3,3),   & 
& cplAhHmcHm(3,2,2),cplAhHmcVWm(3,2),cplcFdFdAhL(3,3,3),cplcFdFdAhR(3,3,3),              & 
...
& MFe,MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,cplAhcHmVWm,          & 
...
& cplhhcHmVWm,cplhhcVWmVWm,cplhhHmcHm,cplhhHmcVWm,cplHmcHmVZ,cplHmcVWmVZ,TSOdulvSLL,     & 
...
Complex(dp),Intent(in) :: cplAhcHmVWm(3,2),cplAhHmcHm(3,2,2),cplAhHmcVWm(3,2),cplcFdFdAhL(3,3,3),               & 
...
& cplcFeFehhR(3,3,3),cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),cplcFeFvHmL(3,6,2),               & 
& cplcFeFvHmR(3,6,2),cplcFeFvVWmL(3,6),cplcFeFvVWmR(3,6),cplcFuFdcHmL(3,3,2),            & 
& cplcFuFdcHmR(3,3,2),cplcFuFdcVWmL(3,3),cplcFuFdcVWmR(3,3),cplcFuFuAhL(3,3,3),          & 
& cplcFuFuAhR(3,3,3),cplcFuFuhhL(3,3,3),cplcFuFuhhR(3,3,3),cplcFuFuVZL(3,3),             & 
& cplcFuFuVZR(3,3),cplcHmVWmVZ(2),cplcVWmVWmVZ,cplFvFecHmL(6,3,2),cplFvFecHmR(6,3,2),    & 
& cplFvFecVWmL(6,3),cplFvFecVWmR(6,3),cplFvFvAhL(6,6,3),cplFvFvAhR(6,6,3),               & 
& cplFvFvhhL(6,6,3),cplFvFvhhR(6,6,3),cplFvFvVZL(6,6),cplFvFvVZR(6,6),cplhhcHmVWm(3,2),  & 
& cplhhcVWmVWm(3),cplhhHmcHm(3,2,2),cplhhHmcVWm(3,2),cplHmcHmVZ(2,2),cplHmcVWmVZ(2)
...
& cplcFuFuVZR,cplcHmVWmVZ,cplcVWmVWmVZ,cplFvFecHmL,cplFvFecHmR,cplFvFecVWmL,             & 
& cplFvFecVWmR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVZL,cplFvFvVZR,        & 
& cplhhcHmVWm,cplhhcVWmVWm,cplhhHmcHm,cplhhHmcVWm,cplHmcHmVZ,cplHmcVWmVZ,TVOdulvSLL,     & 
...
& Mhh,Mhh2,MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,cplAhhhVP,cplcFdFdAhL,cplcFdFdAhR,               & 
...
& cplhhVPVZ,cplHmcHmVP,cplHmcVWmVP,OA2qSL,OA2qSR,OA2qVL,OA2qVR)
...
Complex(dp),Intent(in) :: cplAhhhVP(3,3),cplcFdFdAhL(3,3,3),cplcFdFdAhR(3,3,3),cplcFdFdhhL(3,3,3),              & 
& cplcFdFdhhR(3,3,3),cplcFdFdVPL(3,3),cplcFdFdVPR(3,3),cplcFdFdVZL(3,3),cplcFdFdVZR(3,3),& 
& cplcFdFuHmL(3,3,2),cplcFdFuHmR(3,3,2),cplcFdFuVWmL(3,3),cplcFdFuVWmR(3,3),             & 
& cplcFuFdcHmL(3,3,2),cplcFuFdcHmR(3,3,2),cplcFuFdcVWmL(3,3),cplcFuFdcVWmR(3,3),         & 
& cplcFuFuVPL(3,3),cplcFuFuVPR(3,3),cplcHmVPVWm(2),cplcVWmVPVWm,cplhhVPVZ(3),            & 
...
& cplcFdFuHmL(3,3,2),cplcFdFuHmR(3,3,2),cplcFdFuVWmL(3,3),cplcFdFuVWmR(3,3),             & 
& cplcFuFdcHmL(3,3,2),cplcFuFdcHmR(3,3,2),cplcFuFdcVWmL(3,3),cplcFuFdcVWmR(3,3),         & 
& cplcFuFuhhL(3,3,3),cplcFuFuhhR(3,3,3),cplhhcHmVWm(3,2),cplhhcVWmVWm(3),cplhhhhhh(3,3,3),& 
& cplhhHmcHm(3,2,2),cplhhHmcVWm(3,2),cplhhVZVZ(3)
...
End Function C1C2 
End Module FlavorKit_QFV_BGLNCS 
