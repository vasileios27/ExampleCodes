...
Use StandardModel 
Use RunSM_BGLNCS
Use FlavorKit_LFV_BGLNCS
Use FlavorKit_QFV_BGLNCS
Use FlavorKit_Observables_BGLNCS
...
Real(dp),Intent(in)  :: MAh(3),MAh2(3),MFe(3),MFe2(3),MFv(6),MFv2(6),Mhh(3),Mhh2(3),MHm(2),MHm2(2)

Complex(dp),Intent(in)  :: cplcFeFeAhL(3,3,3),cplcFeFeAhR(3,3,3),cplAhhhVP(3,3),cplFvFecHmL(6,3,2),              & 
& cplFvFecHmR(6,3,2),cplcFeFehhL(3,3,3),cplcFeFehhR(3,3,3),cplcFeFeVPL(3,3),             & 
& cplcFeFeVPR(3,3),cplFvFvVPL(6,6),cplFvFvVPR(6,6),cplcFeFvHmL(3,6,2),cplcFeFvHmR(3,6,2),& 
& cplHmcHmVP(2,2)
...
coup2L = cplFvFecHmL(i1,gt2,i3)
coup2R = cplFvFecHmR(i1,gt2,i3)
...
Do i1= 2,2
  Do i2= 1,6
   i3 = i2
  If ((MHm2(i1).gt.mz2).Or.(MFv2(i2).gt.mz2).Or.(MFv2(i3).gt.mz2)) Then
coup1L = cplcFeFvHmL(gt1,i2,i1)
coup1R = cplcFeFvHmR(gt1,i2,i1)
coup2L = cplFvFecHmL(i3,gt2,i1)
coup2R = cplFvFecHmR(i3,gt2,i1)
ratio = MHm2(i1)/MFv2(i2)
 chargefactor = chargefactor*(0._dp)
 If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
...
& MVWm,MVWm2,MVZ,MVZ2,cplcFeFeAhL,cplcFeFeAhR,cplAhhhVP,cplFvFecHmL,cplFvFecHmR,         & 
& cplFvFecVWmL,cplFvFecVWmR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,             & 
& cplcFeFeVZL,cplcFeFeVZR,cplFvFvVPL,cplFvFvVPR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,    & 
& cplcFeFvVWmR,cplHmcHmVP,cplcVWmVPVWm,EDM)
...
Complex(dp),Intent(in)  :: cplcFeFeAhL(3,3,3),cplcFeFeAhR(3,3,3),cplAhhhVP(3,3),cplFvFecHmL(6,3,2),              & 
& cplFvFecHmR(6,3,2),cplFvFecVWmL(6,3),cplFvFecVWmR(6,3),cplcFeFehhL(3,3,3),             & 
& cplcFeFehhR(3,3,3),cplcFeFeVPL(3,3),cplcFeFeVPR(3,3),cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),& 
& cplFvFvVPL(6,6),cplFvFvVPR(6,6),cplcFeFvHmL(3,6,2),cplcFeFvHmR(3,6,2),cplcFeFvVWmL(3,6),& 
& cplcFeFvVWmR(3,6),cplHmcHmVP(2,2),cplcVWmVPVWm
...
!ratio = MFv2(i1)/MHm2(i2)
 !If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
!EDM = EDM +(-1)* chargefactor*Aimag(coup1L*Conjg(coup1R))*FeynFunctionB(ratio)*MFv(i1)/MHm2(i2) 
!End if 
...
coup2L = cplFvFecHmL(i3,gt2,i1)
coup2R = cplFvFecHmR(i3,gt2,i1)
!ratio = MFv2(i2)/MHm2(i1)
 !If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
!EDM = EDM -(0)* chargefactor*Aimag(coup1R*Conjg(coup1L))*FeynFunctionA(ratio)*MFv(i2)/MHm2(i1) 
!End if 
...
& MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,cplAhAhcVWmVWm,cplAhAhVZVZ,cplAhhhVZ,cplAhHmcVWm,         & 
& cplcFdFdVZL,cplcFdFdVZR,cplcFeFeVZL,cplcFeFeVZR,cplcFuFdcVWmL,cplcFuFdcVWmR,           & 
& cplcFuFuVZL,cplcFuFuVZR,cplcgAgWmcVWm,cplcgWmgWmVZ,cplcgWpgAcVWm,cplcgWpgWpVZ,         & 
& cplcgWpgZcVWm,cplcgZgWmcVWm,cplcVWmcVWmVWmVWm1,cplcVWmcVWmVWmVWm2,cplcVWmcVWmVWmVWm3,  & 
...
& cplFvFvVZL,cplFvFvVZR,cplhhcVWmVWm,cplhhhhcVWmVWm,cplhhhhVZVZ,cplhhHmcVWm,             & 
& cplhhVPVZ,cplhhVZVZ,cplHmcHmcVWmVWm,cplHmcHmVZ,cplHmcHmVZVZ,cplHmcVWmVP,               & 
& cplHmcVWmVZ,rho)
...
Complex(dp),Intent(in)  :: cplAhAhcVWmVWm(3,3),cplAhAhVZVZ(3,3),cplAhhhVZ(3,3),cplAhHmcVWm(3,2),cplcFdFdVZL(3,3),& 
& cplcFdFdVZR(3,3),cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),cplcFuFdcVWmL(3,3),cplcFuFdcVWmR(3,3),& 
& cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),cplcgAgWmcVWm,cplcgWmgWmVZ,cplcgWpgAcVWm,            & 
& cplcgWpgWpVZ,cplcgWpgZcVWm,cplcgZgWmcVWm,cplcVWmcVWmVWmVWm1,cplcVWmcVWmVWmVWm2,        & 
& cplcVWmcVWmVWmVWm3,cplcVWmVPVPVWm1,cplcVWmVPVPVWm2,cplcVWmVPVPVWm3,cplcVWmVPVWm,       & 
& cplcVWmVWmVZ,cplcVWmVWmVZVZ1,cplcVWmVWmVZVZ2,cplcVWmVWmVZVZ3,cplFvFecVWmL(6,3),        & 
& cplFvFecVWmR(6,3),cplFvFvVZL(6,6),cplFvFvVZR(6,6),cplhhcVWmVWm(3),cplhhhhcVWmVWm(3,3), & 
& cplhhhhVZVZ(3,3),cplhhHmcVWm(3,2),cplhhVPVZ(3),cplhhVZVZ(3),cplHmcHmcVWmVWm(2,2),      & 
...
& MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,cplAhhhVP,       & 
& cplcFdFdVPL,cplcFdFdVPR,cplcFeFeVPL,cplcFeFeVPR,cplcFuFuVPL,cplcFuFuVPR,               & 
& cplFvFvVPL,cplFvFvVPR,cplcgWmgWmVP,cplcgWpgWpVP,cplhhVPVZ,cplHmcHmVP,cplHmcVWmVP,      & 
...
& cplcFuFuVZL,cplcFuFuVZR,cplFvFvVZL,cplFvFvVZR,cplcgWmgWmVZ,cplcgWpgWpVZ,               & 
...
& cplcFeFeVZR,cplcFuFuVZL,cplcFuFuVZR,cplFvFvVZL,cplFvFvVZR,cplcgWmgWmVZ,cplcgWpgWpVZ,   & 
& cplhhVPVZ,cplhhVZVZ,cplHmcHmVZ,cplHmcVWmVZ,cplcVWmVWmVZ,cplAhAhVZVZ,cplhhhhVZVZ,       & 
& cplHmcHmVZVZ,cplcVWmVWmVZVZ1,cplcVWmVWmVZVZ2,cplcVWmVWmVZVZ3,kont,PiZZ)

Call Pi1LoopVZ(MVZ2,Mhh,Mhh2,MAh,MAh2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,            & 
& MVZ,MVZ2,MHm,MHm2,MVWm,MVWm2,cplAhhhVZ,cplcFdFdVZL,cplcFdFdVZR,cplcFeFeVZL,            & 
& cplcFeFeVZR,cplcFuFuVZL,cplcFuFuVZR,cplFvFvVZL,cplFvFvVZR,cplcgWmgWmVZ,cplcgWpgWpVZ,   & 
& cplhhVPVZ,cplhhVZVZ,cplHmcHmVZ,cplHmcVWmVZ,cplcVWmVWmVZ,cplAhAhVZVZ,cplhhhhVZVZ,       & 
& cplHmcHmVZVZ,cplcVWmVWmVZVZ1,cplcVWmVWmVZVZ2,cplcVWmVWmVZVZ3,kont,PiZZ_mz2)
...
Call Pi1LoopVWm(MVWm2,MHm,MHm2,MAh,MAh2,MFu,MFu2,MFd,MFd2,MFv,MFv2,MFe,               & 
& MFe2,Mhh,Mhh2,MVWm,MVWm2,MVZ,MVZ2,cplAhHmcVWm,cplcFuFdcVWmL,cplcFuFdcVWmR,             & 
& cplFvFecVWmL,cplFvFecVWmR,cplcgWpgAcVWm,cplcgAgWmcVWm,cplcgZgWmcVWm,cplcgWpgZcVWm,     & 
& cplhhHmcVWm,cplhhcVWmVWm,cplHmcVWmVP,cplHmcVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,            & 
& cplAhAhcVWmVWm,cplhhhhcVWmVWm,cplHmcHmcVWmVWm,cplcVWmVPVPVWm3,cplcVWmVPVPVWm1,         & 
...
& Mhh2,MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,cplAhAhVPVZ,cplAhhhVP,cplAhhhVZ,cplcFdFdVPL,         & 
...
& cplcVWmVPVPVWm3,cplcVWmVPVPVWm1,cplcVWmVPVPVWm2,kont,Pigg_mz2)
...
& Lam3input,Lam4input,Lam2input,Lam1Dashinput,Lam2Dashinput,Lam3Dashinput,               & 
...
& Mu1input,Mu2input,MuDashinput,Mubinput,Mu3input,v1input,v2input,v3input,               & 
& Tpar,Spar,Upar,ae,amu,atau,EDMe,EDMmu,EDMtau,dRho,BrBsGamma,ratioBsGamma,              & 
...
Real(dp),Intent(inout) :: g1input,g2input,g3input,Mu1input,Mu2input,MuDashinput,v1input,v2input,v3input

Complex(dp),Intent(inout) :: Lam1input,Lam3input,Lam4input,Lam2input,Lam1Dashinput,Lam2Dashinput,Lam3Dashinput,    & 
& Aa3input,Aa4input,Y1d11input,Y1d12input,Y1d13input,Y1d21input,Y1d22input,              & 
& Y1d23input,Y2d31input,Y2d32input,Y2d33input,Y1u11input,Y1u12input,Y1u21input,          & 
& Y1u22input,Y2u33input,Y1e11input,Y1e22input,Y1e21input,Y2e33input,Y1n11input,          & 
& Y1n22input,Y1n12input,Y2n33input,C23input,C32input,BB11input,Aa1input,Aa2input,        & 
...
Complex(dp) :: cplAhAhAh(3,3,3),cplAhAhcVWmVWm(3,3),cplAhAhhh(3,3,3),cplAhAhVPVP(3,3),               & 
& cplAhAhVPVZ(3,3),cplAhAhVZVZ(3,3),cplAhcHmVWm(3,2),cplAhhhhh(3,3,3),cplAhhhVP(3,3),    & 
& cplAhhhVZ(3,3),cplAhHmcHm(3,2,2),cplAhHmcVWm(3,2),cplcFdFdAhL(3,3,3),cplcFdFdAhR(3,3,3),& 
...
& cplcFdFuHmR(3,3,2),cplcFdFuVWmL(3,3),cplcFdFuVWmR(3,3),cplcFeFeAhL(3,3,3),             & 
& cplcFeFeAhR(3,3,3),cplcFeFehhL(3,3,3),cplcFeFehhR(3,3,3),cplcFeFeVPL(3,3),             & 
& cplcFeFeVPR(3,3),cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),cplcFeFvHmL(3,6,2),cplcFeFvHmR(3,6,2),& 
...
& cplcgWmgWmVP,cplcgWmgWmVZ,cplcgWpgAcVWm,cplcgWpgWpVP,cplcgWpgWpVZ,cplcgWpgZcVWm,       & 
...
& cplcVWmVWmVZVZ2,cplcVWmVWmVZVZ3,cplFvFecHmL(6,3,2),cplFvFecHmR(6,3,2),cplFvFecVWmL(6,3),& 
& cplFvFecVWmR(6,3),cplFvFvAhL(6,6,3),cplFvFvAhR(6,6,3),cplFvFvhhL(6,6,3),               & 
& cplFvFvhhR(6,6,3),cplFvFvVPL(6,6),cplFvFvVPR(6,6),cplFvFvVZL(6,6),cplFvFvVZR(6,6),     & 
& cplhhcHmVWm(3,2),cplhhcVWmVWm(3),cplhhhhcVWmVWm(3,3),cplhhhhhh(3,3,3),cplhhhhVPVP(3,3),& 
& cplhhhhVPVZ(3,3),cplhhhhVZVZ(3,3),cplhhHmcHm(3,2,2),cplhhHmcVWm(3,2),cplhhVPVZ(3),     & 
& cplhhVZVZ(3),cplHmcHmcVWmVWm(2,2),cplHmcHmVP(2,2),cplHmcHmVPVP(2,2),cplHmcHmVPVZ(2,2), & 
...
scale_save = Qin 
Call RunSM_and_SUSY_RGEs(160._dp,g1input,g2input,g3input,Lam1input,Lam3input,         & 
...
& Y1e11input,Y1e22input,Y1e21input,Y2e33input,Y1n11input,Y1n22input,Y1n12input,          & 
& Y2n33input,C23input,C32input,BB11input,Aa1input,Aa2input,Mu1input,Mu2input,            & 
& MuDashinput,Mubinput,Mu3input,v1input,v2input,v3input,g1,g2,g3,Lam1,Lam3,              & 
& Lam4,Lam2,Lam1Dash,Lam2Dash,Lam3Dash,Aa3,Aa4,Y1d11,Y1d12,Y1d13,Y1d21,Y1d22,            & 
& Y1d23,Y2d31,Y2d32,Y2d33,Y1u11,Y1u12,Y1u21,Y1u22,Y2u33,Y1e11,Y1e22,Y1e21,               & 
& Y2e33,Y1n11,Y1n22,Y1n12,Y2n33,C23,C32,BB11,Aa1,Aa2,Mu1,Mu2,MuDash,Mub,Mu3,             & 
& v1,v2,v3,CKM_160,sinW2_160,Alpha_160,AlphaS_160,.false.)
...
Lam4input = Lam4
Lam2input = Lam2
Lam1Dashinput = Lam1Dash
Lam2Dashinput = Lam2Dash
Lam3Dashinput = Lam3Dash
Aa3input = Aa3
Aa4input = Aa4
Y1d11input = Y1d11
Y1d12input = Y1d12
...
MHm(1)=MVWm
MHm2(1)=MVWm2
Call AllCouplings(Aa1,Aa2,Aa3,Aa4,v1,v2,v3,ZA,Lam1,Lam3,Lam4,Lam2,Lam1Dash,           & 
& Lam2Dash,Lam3Dash,ZH,ZP,g1,g2,ZZ,g3,Y1d11,Y1d12,Y1d13,Y1d21,Y1d22,Y1d23,               & 
& Y2d31,Y2d32,Y2d33,ZDL,ZDR,Y1e11,Y1e22,Y1e21,Y2e33,ZEL,ZER,Y1u11,Y1u12,Y1u21,           & 
& Y1u22,Y2u33,ZUL,ZUR,Y1n11,Y1n22,Y1n12,Y2n33,C23,C32,Vv,cplAhAhAh,cplAhAhhh,            & 
& cplAhhhhh,cplAhHmcHm,cplhhhhhh,cplhhHmcHm,cplAhhhVP,cplAhhhVZ,cplAhHmcVWm,             & 
& cplAhcHmVWm,cplhhHmcVWm,cplhhcHmVWm,cplHmcHmVP,cplHmcHmVZ,cplhhVPVZ,cplhhcVWmVWm,      & 
...
& cplcFdFuVWmR,cplcFuFuVZL,cplcFuFuVZR,cplFvFvVPL,cplFvFvVPR,cplFvFvVZL,cplFvFvVZR,      & 
& cplcFeFvVWmL,cplcFeFvVWmR)
...
& MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,cplAhAhAh,cplAhAhhh,           & 
& cplAhcHmVWm,cplAhhhhh,cplAhhhVP,cplAhhhVZ,cplAhHmcHm,cplAhHmcVWm,cplcFdFdAhL,          & 
...
& cplcFuFuhhR,cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,cplcFuFuVZR,cplcHmVPVWm,               & 
& cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,cplFvFecHmL,cplFvFecHmR,cplFvFecVWmL,            & 
& cplFvFecVWmR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVPL,cplFvFvVPR,        & 
& cplFvFvVZL,cplFvFvVZR,cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,       & 
& cplhhVPVZ,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,TSOddllSLL(gt1,gt2,gt3,gt4)& 
...
& cplFvFecVWmR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVPL,cplFvFvVPR,        & 
& cplFvFvVZL,cplFvFvVZR,cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,       & 
& cplhhVPVZ,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,TVOddllSLL(gt1,gt2,gt3,gt4)& 
...
& MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,cplAhAhAh,cplAhAhhh,      & 
& cplAhcHmVWm,cplAhhhhh,cplAhhhVP,cplAhhhVZ,cplAhHmcHm,cplAhHmcVWm,cplcFdFdAhL,          & 
& cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,               & 
& cplcFdFdVZR,cplcFdFuHmL,cplcFdFuHmR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFeFeAhL,             & 
& cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,               & 
...
& cplFvFecVWmR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVPL,cplFvFvVPR,        & 
& cplFvFvVZL,cplFvFvVZR,cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,       & 
& cplhhVPVZ,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,TSOddvvVRR(gt1,gt2,gt3,gt4)& 
...
& cplFvFecVWmR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVPL,cplFvFvVPR,        & 
& cplFvFvVZL,cplFvFvVZR,cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,       & 
& cplhhVPVZ,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,TVOddvvVRR(gt1,gt2,gt3,gt4)& 
...
& cplAhhhVP,cplAhhhVZ,cplAhHmcHm,cplAhHmcVWm,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,        & 
...
& cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,cplhhVPVZ,cplhhVZVZ,cplHmcHmVP,          & 
& cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,TSO4dSLL(gt1,gt2,gt3,gt4),TSO4dSRR(gt1,gt2,gt3,gt4) & 
...
& cplcFuFuVZR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,cplhhcHmVWm,             & 
& cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,cplhhVPVZ,cplhhVZVZ,cplHmcHmVP,          & 
& cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,TVO4dSLL(gt1,gt2,gt3,gt4),TVO4dSRR(gt1,gt2,gt3,gt4) & 
...
& MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,cplAhcHmVWm,cplAhHmcHm,        & 
...
& cplcFuFuVZR,cplcHmVWmVZ,cplcVWmVWmVZ,cplFvFecHmL,cplFvFecHmR,cplFvFecVWmL,             & 
& cplFvFecVWmR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVZL,cplFvFvVZR,        & 
& cplhhcHmVWm,cplhhcVWmVWm,cplhhHmcHm,cplhhHmcVWm,cplHmcHmVZ,cplHmcVWmVZ,TSOdulvSLL(gt1,gt2,gt3,gt4)& 
...
& cplcFuFuVZR,cplcHmVWmVZ,cplcVWmVWmVZ,cplFvFecHmL,cplFvFecHmR,cplFvFecVWmL,             & 
& cplFvFecVWmR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVZL,cplFvFvVZR,        & 
& cplhhcHmVWm,cplhhcVWmVWm,cplhhHmcHm,cplhhHmcVWm,cplHmcHmVZ,cplHmcVWmVZ,TVOdulvSLL(gt1,gt2,gt3,gt4)& 
...
& cplFvFecVWmR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVPL,cplFvFvVPR,        & 
& cplFvFvVZL,cplFvFvVZR,cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,       & 
& cplhhVPVZ,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,BOddllSLL(gt1,gt2,gt3,gt4)& 
...
& cplFvFecVWmR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVPL,cplFvFvVPR,        & 
& cplFvFvVZL,cplFvFvVZR,cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,       & 
& cplhhVPVZ,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,PSOddllSLL(gt1,gt2,gt3,gt4)& 
...
& cplFvFecVWmR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVPL,cplFvFvVPR,        & 
& cplFvFvVZL,cplFvFvVZR,cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,       & 
& cplhhVPVZ,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,PVOddllSLL(gt1,gt2,gt3,gt4)& 
...
& cplFvFecVWmR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVPL,cplFvFvVPR,        & 
& cplFvFvVZL,cplFvFvVZR,cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,       & 
& cplhhVPVZ,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,BOddvvVRR(gt1,gt2,gt3,gt4)& 
...
& cplFvFecVWmR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVPL,cplFvFvVPR,        & 
& cplFvFvVZL,cplFvFvVZR,cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,       & 
& cplhhVPVZ,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,PSOddvvVRR(gt1,gt2,gt3,gt4)& 
...
& cplFvFecVWmR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVPL,cplFvFvVPR,        & 
& cplFvFvVZL,cplFvFvVZR,cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,       & 
& cplhhVPVZ,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,PVOddvvVRR(gt1,gt2,gt3,gt4)& 
...
& cplcFuFuVZR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,cplhhcHmVWm,             & 
& cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,cplhhVPVZ,cplhhVZVZ,cplHmcHmVP,          & 
& cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,BO4dSLL(gt1,gt2,gt3,gt4),BO4dSRR(gt1,gt2,gt3,gt4)   & 
...
& Mhh2,MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,cplAhhhVP,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,       & 
...
& cplcFuFdcVWmR,cplcFuFuVPL,cplcFuFuVPR,cplcHmVPVWm,cplcVWmVPVWm,cplhhVPVZ,              & 
...
& cplFvFecVWmR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVPL,cplFvFvVPR,        & 
& cplFvFvVZL,cplFvFvVZR,cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,       & 
& cplhhVPVZ,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,TSOddllSLLSM(gt1,gt2,gt3,gt4)& 
...
& cplFvFecVWmR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVPL,cplFvFvVPR,        & 
& cplFvFvVZL,cplFvFvVZR,cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,       & 
& cplhhVPVZ,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,TVOddllSLLSM(gt1,gt2,gt3,gt4)& 
...
& cplFvFecVWmR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVPL,cplFvFvVPR,        & 
& cplFvFvVZL,cplFvFvVZR,cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,       & 
& cplhhVPVZ,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,TSOddvvVRRSM(gt1,gt2,gt3,gt4)& 
...
& cplFvFecVWmR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVPL,cplFvFvVPR,        & 
& cplFvFvVZL,cplFvFvVZR,cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,       & 
& cplhhVPVZ,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,TVOddvvVRRSM(gt1,gt2,gt3,gt4)& 
...
& cplcFuFuVZR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,cplhhcHmVWm,             & 
& cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,cplhhVPVZ,cplhhVZVZ,cplHmcHmVP,          & 
& cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,TSO4dSLLSM(gt1,gt2,gt3,gt4),TSO4dSRRSM(gt1,gt2,gt3,gt4)& 
...
& cplcFuFuVZR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,cplhhcHmVWm,             & 
& cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,cplhhVPVZ,cplhhVZVZ,cplHmcHmVP,          & 
& cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,TVO4dSLLSM(gt1,gt2,gt3,gt4),TVO4dSRRSM(gt1,gt2,gt3,gt4)& 
...
& cplcFuFuVZR,cplcHmVWmVZ,cplcVWmVWmVZ,cplFvFecHmL,cplFvFecHmR,cplFvFecVWmL,             & 
& cplFvFecVWmR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVZL,cplFvFvVZR,        & 
& cplhhcHmVWm,cplhhcVWmVWm,cplhhHmcHm,cplhhHmcVWm,cplHmcHmVZ,cplHmcVWmVZ,TSOdulvSLLSM(gt1,gt2,gt3,gt4)& 
...
& cplcFuFuVZR,cplcHmVWmVZ,cplcVWmVWmVZ,cplFvFecHmL,cplFvFecHmR,cplFvFecVWmL,             & 
& cplFvFecVWmR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVZL,cplFvFvVZR,        & 
& cplhhcHmVWm,cplhhcVWmVWm,cplhhHmcHm,cplhhHmcVWm,cplHmcHmVZ,cplHmcVWmVZ,TVOdulvSLLSM(gt1,gt2,gt3,gt4)& 
...
& cplFvFecVWmR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVPL,cplFvFvVPR,        & 
& cplFvFvVZL,cplFvFvVZR,cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,       & 
& cplhhVPVZ,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,BOddllSLLSM(gt1,gt2,gt3,gt4)& 
...
& cplFvFecVWmR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVPL,cplFvFvVPR,        & 
& cplFvFvVZL,cplFvFvVZR,cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,       & 
& cplhhVPVZ,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,PSOddllSLLSM(gt1,gt2,gt3,gt4)& 
...
& cplFvFecVWmR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVPL,cplFvFvVPR,        & 
& cplFvFvVZL,cplFvFvVZR,cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,       & 
& cplhhVPVZ,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,PVOddllSLLSM(gt1,gt2,gt3,gt4)& 
...
& cplFvFecVWmR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVPL,cplFvFvVPR,        & 
& cplFvFvVZL,cplFvFvVZR,cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,       & 
& cplhhVPVZ,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,BOddvvVRRSM(gt1,gt2,gt3,gt4)& 
...
& cplFvFecVWmR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVPL,cplFvFvVPR,        & 
& cplFvFvVZL,cplFvFvVZR,cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,       & 
& cplhhVPVZ,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,PSOddvvVRRSM(gt1,gt2,gt3,gt4)& 
...
& cplFvFecVWmR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVPL,cplFvFvVPR,        & 
& cplFvFvVZL,cplFvFvVZR,cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,       & 
& cplhhVPVZ,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,PVOddvvVRRSM(gt1,gt2,gt3,gt4)& 
...
& cplcFuFuVZR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,cplhhcHmVWm,             & 
& cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,cplhhVPVZ,cplhhVZVZ,cplHmcHmVP,          & 
& cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,BO4dSLLSM(gt1,gt2,gt3,gt4),BO4dSRRSM(gt1,gt2,gt3,gt4)& 
...
If (MatchingOrder.gt.-1) Then 
Call RunSM_and_SUSY_RGEs(mz,g1input,g2input,g3input,Lam1input,Lam3input,              & 
& Lam4input,Lam2input,Lam1Dashinput,Lam2Dashinput,Lam3Dashinput,Aa3input,Aa4input,       & 
& Y1d11input,Y1d12input,Y1d13input,Y1d21input,Y1d22input,Y1d23input,Y2d31input,          & 
& Y2d32input,Y2d33input,Y1u11input,Y1u12input,Y1u21input,Y1u22input,Y2u33input,          & 
& Y1e11input,Y1e22input,Y1e21input,Y2e33input,Y1n11input,Y1n22input,Y1n12input,          & 
...
& Y1d23,Y2d31,Y2d32,Y2d33,Y1u11,Y1u12,Y1u21,Y1u22,Y2u33,Y1e11,Y1e22,Y1e21,               & 
& Y2e33,Y1n11,Y1n22,Y1n12,Y2n33,C23,C32,BB11,Aa1,Aa2,Mu1,Mu2,MuDash,Mub,Mu3,             & 
& v1,v2,v3,CKM_MZ,sinW2_MZ,Alpha_MZ,AlphaS_MZ,.true.)
...
& cplFvFecVWmR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVPL,cplFvFvVPR,        & 
& cplFvFvVZL,cplFvFvVZR,cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,       & 
& cplhhVPVZ,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,TSOllddSLL(gt1,gt2,gt3,gt4)& 
...
& cplFvFecVWmR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVPL,cplFvFvVPR,        & 
& cplFvFvVZL,cplFvFvVZR,cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,       & 
& cplhhVPVZ,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,TVOllddSLL(gt1,gt2,gt3,gt4)& 
...
& cplFvFecVWmR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVPL,cplFvFvVPR,        & 
& cplFvFvVZL,cplFvFvVZR,cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,       & 
& cplhhVPVZ,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,TSOlluuSLL(gt1,gt2,gt3,gt4)& 
...
& cplFvFecVWmR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVPL,cplFvFvVPR,        & 
& cplFvFvVZL,cplFvFvVZR,cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,       & 
& cplhhVPVZ,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,TVOlluuSLL(gt1,gt2,gt3,gt4)& 
...
& Mhh,Mhh2,MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,cplAhAhAh,cplAhAhhh,cplAhcHmVWm,cplAhhhhh,       & 
& cplAhhhVP,cplAhhhVZ,cplAhHmcHm,cplAhHmcVWm,cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,        & 
& cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFvHmL,               & 
& cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVPVWm,            & 
& cplcVWmVWmVZ,cplFvFecHmL,cplFvFecHmR,cplFvFecVWmL,cplFvFecVWmR,cplFvFvAhL,             & 
& cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVPL,cplFvFvVPR,cplFvFvVZL,cplFvFvVZR,          & 
& cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,cplhhVPVZ,cplhhVZVZ,         & 
& cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,TSO4lSLL(gt1,gt2,gt3,gt4),               & 
...
& cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVPL,cplFvFvVPR,cplFvFvVZL,cplFvFvVZR,          & 
& cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,cplhhVPVZ,cplhhVZVZ,         & 
& cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,TVO4lSLL(gt1,gt2,gt3,gt4),               & 
...
& MFv2,Mhh,Mhh2,MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,cplAhAhAh,cplAhAhhh,cplAhcHmVWm,            & 
& cplAhhhhh,cplAhhhVP,cplAhhhVZ,cplAhHmcHm,cplAhHmcVWm,cplcFeFeAhL,cplcFeFeAhR,          & 
...
& cplcVWmVPVWm,cplcVWmVWmVZ,cplFvFecHmL,cplFvFecHmR,cplFvFecVWmL,cplFvFecVWmR,           & 
& cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVPL,cplFvFvVPR,cplFvFvVZL,          & 
& cplFvFvVZR,cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,cplhhVPVZ,        & 
& cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,TSO4lSLLcross(gt1,gt2,gt3,gt4) & 
...
& cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVPL,cplFvFvVPR,cplFvFvVZL,          & 
& cplFvFvVZR,cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,cplhhVPVZ,        & 
& cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,TVO4lSLLcross(gt1,gt2,gt3,gt4) & 
...
& cplFvFecVWmR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVPL,cplFvFvVPR,        & 
& cplFvFvVZL,cplFvFvVZR,cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,       & 
& cplhhVPVZ,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,BOllddSLL(gt1,gt2,gt3,gt4)& 
...
& cplFvFecVWmR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVPL,cplFvFvVPR,        & 
& cplFvFvVZL,cplFvFvVZR,cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,       & 
& cplhhVPVZ,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,PSOllddSLL(gt1,gt2,gt3,gt4)& 
...
& cplFvFecVWmR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVPL,cplFvFvVPR,        & 
& cplFvFvVZL,cplFvFvVZR,cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,       & 
& cplhhVPVZ,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,PVOllddSLL(gt1,gt2,gt3,gt4)& 
...
& cplFvFecVWmR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVPL,cplFvFvVPR,        & 
& cplFvFvVZL,cplFvFvVZR,cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,       & 
& cplhhVPVZ,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,BOlluuSLL(gt1,gt2,gt3,gt4)& 
...
& cplFvFecVWmR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVPL,cplFvFvVPR,        & 
& cplFvFvVZL,cplFvFvVZR,cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,       & 
& cplhhVPVZ,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,PSOlluuSLL(gt1,gt2,gt3,gt4)& 
...
& cplFvFecVWmR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVPL,cplFvFvVPR,        & 
& cplFvFvVZL,cplFvFvVZR,cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,       & 
& cplhhVPVZ,cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,PVOlluuSLL(gt1,gt2,gt3,gt4)& 
...
& cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVPL,cplFvFvVPR,cplFvFvVZL,cplFvFvVZR,          & 
& cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,cplhhVPVZ,cplhhVZVZ,         & 
& cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,BO4lSLL(gt1,gt2,gt3,gt4),BO4lSRR(gt1,gt2,gt3,gt4)& 
...
& cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVPL,cplFvFvVPR,cplFvFvVZL,cplFvFvVZR,          & 
& cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,cplhhVPVZ,cplhhVZVZ,         & 
& cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,PSO4lSLL(gt1,gt2,gt3,gt4),               & 
...
& cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVPL,cplFvFvVPR,cplFvFvVZL,cplFvFvVZR,          & 
& cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,cplhhVPVZ,cplhhVZVZ,         & 
& cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,PVO4lSLL(gt1,gt2,gt3,gt4),               & 
...
& cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVPL,cplFvFvVPR,cplFvFvVZL,          & 
& cplFvFvVZR,cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,cplhhVPVZ,        & 
& cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,BO4lSLLcross(gt1,gt2,gt3,gt4)  & 
...
& cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVPL,cplFvFvVPR,cplFvFvVZL,          & 
& cplFvFvVZR,cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,cplhhVPVZ,        & 
& cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,PSO4lSLLcross(gt1,gt2,gt3,gt4) & 
...
& cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVPL,cplFvFvVPR,cplFvFvVZL,          & 
& cplFvFvVZR,cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,cplhhVPVZ,        & 
& cplhhVZVZ,cplHmcHmVP,cplHmcHmVZ,cplHmcVWmVP,cplHmcVWmVZ,PVO4lSLLcross(gt1,gt2,gt3,gt4) & 
...
& Mhh2,MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,cplAhhhVP,cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,       & 
& cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFvHmL,               & 
& cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,cplcHmVPVWm,cplcVWmVPVWm,cplFvFecHmL,            & 
& cplFvFecHmR,cplFvFecVWmL,cplFvFecVWmR,cplFvFvVPL,cplFvFvVPR,cplhhVPVZ,cplHmcHmVP,      & 
...
& MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,cplAhAhhh,cplAhhhhh,cplAhhhVZ,cplcFeFeAhL,cplcFeFeAhR,    & 
...
& cplFvFvhhL,cplFvFvhhR,cplhhcHmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,       & 
...
& cplcFeFvVWmR,cplcHmVWmVZ,cplcVWmVWmVZ,cplFvFecHmL,cplFvFecHmR,cplFvFecVWmL,            & 
& cplFvFecVWmR,cplFvFvVZL,cplFvFvVZR,cplhhVZVZ,cplHmcHmVZ,cplHmcVWmVZ,OZ2lSL(gt1,gt2)    & 
...
& MVZ,MVZ2,cplcFeFeAhL,cplcFeFeAhR,cplAhhhVP,cplFvFecHmL,cplFvFecHmR,cplFvFecVWmL,       & 
& cplFvFecVWmR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,              & 
& cplcFeFeVZR,cplFvFvVPL,cplFvFvVPR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,   & 
& cplHmcHmVP,cplcVWmVPVWm,EDMe)

Call LeptonEDM(2,MAh,MAh2,MFe,MFe2,MFv,MFv2,Mhh,Mhh2,MHm,MHm2,MVWm,MVWm2,             & 
& MVZ,MVZ2,cplcFeFeAhL,cplcFeFeAhR,cplAhhhVP,cplFvFecHmL,cplFvFecHmR,cplFvFecVWmL,       & 
& cplFvFecVWmR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,              & 
& cplcFeFeVZR,cplFvFvVPL,cplFvFvVPR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,   & 
& cplHmcHmVP,cplcVWmVPVWm,EDMmu)

Call LeptonEDM(3,MAh,MAh2,MFe,MFe2,MFv,MFv2,Mhh,Mhh2,MHm,MHm2,MVWm,MVWm2,             & 
& MVZ,MVZ2,cplcFeFeAhL,cplcFeFeAhR,cplAhhhVP,cplFvFecHmL,cplFvFecHmR,cplFvFecVWmL,       & 
& cplFvFecVWmR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,              & 
& cplcFeFeVZR,cplFvFvVPL,cplFvFvVPR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,   & 
& cplHmcHmVP,cplcVWmVPVWm,EDMtau)
...
& MHm2,MVWm,MVWm2,MVZ,MVZ2,cplAhAhcVWmVWm,cplAhAhVZVZ,cplAhhhVZ,cplAhHmcVWm,             & 
& cplcFdFdVZL,cplcFdFdVZR,cplcFeFeVZL,cplcFeFeVZR,cplcFuFdcVWmL,cplcFuFdcVWmR,           & 
& cplcFuFuVZL,cplcFuFuVZR,cplcgAgWmcVWm,cplcgWmgWmVZ,cplcgWpgAcVWm,cplcgWpgWpVZ,         & 
& cplcgWpgZcVWm,cplcgZgWmcVWm,cplcVWmcVWmVWmVWm1,cplcVWmcVWmVWmVWm2,cplcVWmcVWmVWmVWm3,  & 
& cplcVWmVPVPVWm1,cplcVWmVPVPVWm2,cplcVWmVPVPVWm3,cplcVWmVPVWm,cplcVWmVWmVZ,             & 
...
& MFe2,MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHm,MHm2,MVWm,MVWm2,MVZ,MVZ2,cplAhhhVP,cplcFdFdVPL,    & 
